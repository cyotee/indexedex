...
forge script --rpc-url sepolia_alchemy --batch-size 4 scripts/foundry/local/Sepolia_01_Deploy.s.sol
forge script --rpc-url sepolia_alchemy --broadcast --batch-size 4 scripts/foundry/local/Sepolia_01_Deploy.s.sol
forge script --rpc-url sepolia_alchemy --batch-size 4 scripts/foundry/local/Sepolia_02_Test_Tokens_and_Pools.s.sol
forge script --rpc-url sepolia_alchemy --broadcast --batch-size 4 scripts/foundry/local/Sepolia_02_Test_Tokens_and_Pools.s.sol
