...
contract Local_07_Crane_Components
is
    ...
    Script_Indexedex_Uniswap_V2
{
    ...
    function setUp() public virtual {
        ...
        setOwner(deployer());
        setDeploymentPath(string.concat(LOCAL_DEPLOYMENTS_PATH, CRANE_COMPONENTS_FILE));
    ...
    override(
        ...
        declare("erc20MetadataFacet", address(erc20MetadataFacet()));
