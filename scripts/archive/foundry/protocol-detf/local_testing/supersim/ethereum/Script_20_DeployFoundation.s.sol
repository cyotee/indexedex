...
import {Script_DeployProtocolDetfMinimal} from "../../../supersim/ethereum/Script_DeployProtocolDetfMinimal.s.sol";
...
contract Script_20_DeployFoundation is LocalTestingSuperSimBase, Script_DeployProtocolDetfMinimal {
    ...
    function _writeFoundationManifest() internal {
        ...
        json = vm.serializeAddress("", "inventoryDetf", vm.parseJsonAddress(detfJson, ".inventoryDetf"));
