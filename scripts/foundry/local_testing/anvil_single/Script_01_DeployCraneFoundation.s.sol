...
/// @notice Deploys the reusable local-testing Crane foundation
/// @dev Includes factory deployment plus the shared facets needed by later local testing stages
contract Script_01_DeployCraneFoundation is LocalTestingDeploymentBase {
