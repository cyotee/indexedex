...
/// @dev Do not seed SE inventory here — stage 19 market buy moves the mid; pre-buy seed leaves
///      managed ticks out-of-range and later exchangeIn/bond hits _depositQuote div-by-zero.
///      First bond (stage 20) funds the empty SE at the post-buy mid.
contract Script_15_DeployUniV3SeOnRichPool is DeploymentBase {
    ...
    string internal constant PONS_FILE = "14_pons_rich.json";
    string internal constant ARTIFACT_FILE = "15_univ3_se_rich.json";
    ...
    function run() external {
        ...
        _loadPrior();
        _logHeader("Stage 15: Uni V3 SE on RICH/WETH pool");
