...
/// @notice Uni V3 SE DFPkg. Binds the canonical Robinhood V3 factory. No SE instances.
library Phase_05_Stage_04_UniswapV3StandardExchangePkg {
    ...
    function execute(LaunchState storage s) internal {
        require(RobinhoodCanonicalLib.v3Factory() != address(0) && RobinhoodCanonicalLib.v3Factory().code.length > 0, "Phase 05-04: v3Factory");
        ...
        init_.uniswapV3Factory = IUniswapV3Factory(RobinhoodCanonicalLib.v3Factory());
