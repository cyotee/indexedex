...
/// @notice Uni V4 SE + packages for Protocol DETF (CP single) and Curve Quad Stable. No instances.
library Stage_03_UniV4Packages {
    ...
    function _deployDetfChildren(LaunchState storage s) private {
        ...
        IFacet erc721FacetDetf =
            IFacet(s.create3Factory.deployFacet(type(ERC721Facet).creationCode, keccak256("RhMain_ERC721Facet")));
