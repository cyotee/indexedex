...
/// @title Stage_02_Platform
/// @notice FeeCollector + IndexedexManager (registry + fee oracle) + SE rate provider package.
library Stage_02_Platform {
    ...
    function _deployRateProviderPkg(LaunchState storage s) private {
