...
contract Script_19_BootstrapMarketBuyRich is DeploymentBase {
    string internal constant PONS_FILE = "14_pons_rich.json";
    string internal constant ARTIFACT_FILE = "19_market_buy_rich.json";
    ...
    function run() external {
        ...
        _loadPrior();
        _logHeader("Stage 19: Market buy RICH (large WETH in)");
