...
/// @title Script_11_DeployDetfChildren
/// @notice Bond NFT vault DFPkg + rebasing claim DFPkg + default bond terms.
contract Script_11_DeployDetfChildren is DeploymentBase {
    ...
    string internal constant ARTIFACT_FILE = "11_detf_children.json";
    ...
    function run() external {
        ...
        _loadPrior();
        _logHeader("Stage 11: DETF children (bond NFT + rebasing claim)");
    ...
    function _deployBondNftVaultPkg() internal {
        ...
        IFacet erc721FacetDetf =
            IFacet(create3Factory.deployFacet(type(ERC721Facet).creationCode, keccak256("AnvilRh_ERC721Facet")));
    ...
    function _setDefaultBondTerms() internal {
        try IVaultFeeOracleManager(indexedexManager).setDefaultBondTerms(
            BondTerms({
                minLockDuration: FixtureGraph.DEFAULT_MIN_LOCK,
                maxLockDuration: FixtureGraph.DEFAULT_MAX_LOCK,
