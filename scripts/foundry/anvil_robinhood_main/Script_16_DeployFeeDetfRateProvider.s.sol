...
contract Script_16_DeployFeeDetfRateProvider is DeploymentBase {
    ...
    string internal constant ARTIFACT_FILE = "16_fee_detf_rate_provider.json";
    ...
    function run() external {
        ...
        _loadPrior();
        _logHeader("Stage 16: Rate provider (SE shares -> WETH)");
