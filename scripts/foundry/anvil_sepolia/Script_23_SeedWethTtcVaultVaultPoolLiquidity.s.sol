...
contract Script_23_SeedWethTtcVaultVaultPoolLiquidity is DeploymentBase {
    ...
    function _loadPreviousDeployments() internal {
        ...
        uniAbVault = _readAddress("09_strategy_vaults.json", "abVault");
        uniAcVault = _readAddress("09_strategy_vaults.json", "acVault");
        uniBcVault = _readAddress("09_strategy_vaults.json", "bcVault");

        aeroAbVault = _readAddress("09_strategy_vaults.json", "aeroAbVault");
        aeroAcVault = _readAddress("09_strategy_vaults.json", "aeroAcVault");
        aeroBcVault = _readAddress("09_strategy_vaults.json", "aeroBcVault");
    ...
    function _mintAeroLPForPool(address pool) internal {
        ...
        uint256 deadline = block.timestamp + 1 hours;
        aerodromeRouter.addLiquidity(token0, token1, false, amt0, amt1, 0, 0, deployer, deadline);
    }
    ...
    function _seedBalancerVaultVaultPool(address balancerPool, address leftVault, address rightVault) internal {
        ...
        // Map amounts to sorted token order (both amounts are equal)
