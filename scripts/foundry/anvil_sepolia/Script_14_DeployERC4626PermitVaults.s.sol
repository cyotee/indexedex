...
/// @dev Run: forge script scripts/foundry/anvil_sepolia/Script_14_DeployERC4626PermitVaults.s.sol --rpc-url http://127.0.0.1:8545 --broadcast --unlocked --sender <DEV_ADDRESS>
contract Script_14_DeployERC4626PermitVaults is DeploymentBase {
    ...
    function _loadPreviousDeployments() internal {
        ...
        ttA = IERC20Metadata(_readAddress("07_test_tokens.json", "testTokenA"));
        ttB = IERC20Metadata(_readAddress("07_test_tokens.json", "testTokenB"));
        ttC = IERC20Metadata(_readAddress("07_test_tokens.json", "testTokenC"));
