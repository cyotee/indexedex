...
contract Script_ExportTokenlists is DeploymentBase {
    ...
    function _exportBalancerPools(string memory chainIdStr) internal {
        ...
        string[] memory vaultTokenEntries = new string[](6);
        ...
        string[] memory combinedEntries = new string[](9);
        combinedEntries[0] = constProdEntries[0];
        combinedEntries[1] = constProdEntries[1];
        combinedEntries[2] = constProdEntries[2];
        combinedEntries[3] = vaultTokenEntries[0];
        combinedEntries[4] = vaultTokenEntries[1];
        combinedEntries[5] = vaultTokenEntries[2];
        combinedEntries[6] = vaultTokenEntries[3];
        combinedEntries[7] = vaultTokenEntries[4];
        combinedEntries[8] = vaultTokenEntries[5];
