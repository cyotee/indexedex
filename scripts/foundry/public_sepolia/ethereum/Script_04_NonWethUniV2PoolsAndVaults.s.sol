...
contract Script_04_NonWethUniV2PoolsAndVaults is DeploymentBase {
    ...
    function run() external {
        ...
        _logHeader("Ethereum Stage 4: Non-WETH UniV2 Pools and Vaults");
    ...
    function _logResults() internal view {
        ...
        _logComplete("Ethereum Stage 4 (Non-WETH)");
    }
}
