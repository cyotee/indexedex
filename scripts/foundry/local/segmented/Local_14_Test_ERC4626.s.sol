...
contract Local_14_Test_ERC4626
is
    ...
    Script_Indexedex_Uniswap_V2
{
    ...
    function setUp() public virtual {
        ...
        erc20MintBurnPkg(ERC20MintBurnOperableFacetDFPkg(parseJsonAddress(craneComponentsDeploymentJson, "erc20MintBurnPkg")));

        string memory indexedexDemoDeploymentJson = loadDeployments(string.concat(LOCAL_DEPLOYMENTS_PATH, INDEXEDEX_DEMO_FILE));
        erc20MinterFacade_ = IERC20MinterFacade(parseJsonAddress(craneComponentsDeploymentJson, "erc20MinterFacade"));
        
        // erc4626DFPkg(ERC4626DFPkg(parseJsonAddress(craneComponentsDeploymentJson, "erc4626DFPkg")));
        // balV3ERC4626RateProviderFacetDFPkg(ERC4626RateProviderFacetDFPkg(parseJsonAddress(craneComponentsDeploymentJson, "erc4626RateProviderFacetDFPkg")));
        // balancerV3ConstantProductPoolStandardVaultPkg(BalancerV3ConstantProductPoolStandardVaultPkg(parseJsonAddress(craneComponentsDeploymentJson, "balancerV3ConstantProductPoolStandardVaultPkg")));
        // permit2(IPermit2(parseJsonAddress(craneComponentsDeploymentJson, "permit2")));
        // balancerV3Vault(IVault(parseJsonAddress(craneComponentsDeploymentJson, "balancerV3Vault")));
        // balancerV3Router(IRouter(parseJsonAddress(craneComponentsDeploymentJson, "balancerV3Router")));
        // uniswapV2Router(IUniswapV2Router(parseJsonAddress(craneComponentsDeploymentJson, "uniswapV2Router")));
        // uniswapV2Factory(IUniswapV2Factory(parseJsonAddress(craneComponentsDeploymentJson, "uniswapV2Factory")));
        // uniswapV2StandardStrategyVaultPkg(UniswapV2StandardStrategyVaultPkg(parseJsonAddress(craneComponentsDeploymentJson, "uniswapV2StandardStrategyVaultPkg")));
        // standardExchangeRateProviderFacetDFPkg(standardExchangeRateProviderFacetDFPkg(parseJsonAddress(craneComponentsDeploymentJson, "StandardExchangeRateProviderFacetDFPkg")));
    }
    ...
    override(
        ...
        // bRatedBCStrategyVaultConstProdPool = createBCRatedStratVaultPool();
        ...
        // cRatedBCStrategyVaultConstProdPool = createCBRatedStratVaultPool();
    ...
    returns(
        ...
        // declare("acUniV2Pool", address(newPool));
    ...
    function createAWETHConstProdPool() public returns(address newPool) {
        ...
        // declare("aWETHConstProdPool", newPool);
    ...
    function createBWETHConstProdPool() public returns(address newPool) {
        ...
        // declare("bWETHConstProdPool", newPool);
    ...
    function createCWETHConstProdPool() public returns(address newPool) {
        ...
        // declare("cWETHConstProdPool", newPool);
    ...
    function createAWrapperConstProdPool() public returns(address newPool) {
        ...
        // declare("aWrapperConstProdPool", newPool);

        ttA.mint(deployer(), tokenAInitAmount);
        // ttB.mint(deployer(), tokenBInitAmount);
        // ttA4626.deposit(ttA4626LPAmt, deployer());
        ttA.approve(address(permit2()), type(uint256).max);
        // ttB.approve(address(permit2()), type(uint256).max);
    ...
    function createBWrapperConstProdPool() public returns(address newPool) {
        ...
        // declare("bWrapperConstProdPool", newPool);
    ...
    function createCWrapperConstProdPool() public returns(address newPool) {
        ...
        // declare("cWrapperConstProdPool", newPool);
    ...
    function createWETHWrapperConstProdPool() public returns(address newPool) {
        ...
        // declare("wethWrapperConstProdPool", newPool);

        // ttC.mint(deployer(), tokenAInitAmount);
        // ttB.mint(deployer(), tokenBInitAmount);
        // ttA4626.deposit(ttA4626LPAmt, deployer());
        weth9().deposit{value: wethInitAmount}();
        weth9().approve(address(permit2()), type(uint256).max);
    ...
    function createABRatedStratVaultPool() public returns(address newPool) {
        ...
        ttA.mint(deployer(), tokenAInitAmount);
        // ttB.mint(deployer(), tokenBInitAmount);
        // abUniV2PoolStrategyVault.deposit(abUniV2PoolStrategyVaultLPAmt / 2, deployer());
        ttA.approve(address(permit2()), type(uint256).max);
        // ttB.approve(address(permit2()), type(uint256).max);
    ...
    function createBARatedStratVaultPool() public returns(address newPool) {
        ...
        // declare("baRatedStratVaultPool", newPool);
    ...
    function createACRatedStratVaultPool() public returns(address newPool) {
        ...
        // declare("acRatedStratVaultPool", newPool);
    ...
    function createCARatedStratVaultPool() public returns(address newPool) {
        ...
        // declare("caRatedStratVaultPool", newPool);
    ...
    function createABACStratVaultPool() public returns(address newPool) {
        ...
        // uint256 abRatedStratVaultBPTOut = 
    ...
    function createBCRatedStratVaultPool() public returns(address newPool) {
        ...
        // declare("bcRatedStratVaultPool", newPool);
    ...
    function createCBRatedStratVaultPool() public returns(address newPool) {
        ...
        // declare("cbRatedStratVaultPool", newPool);
