...
contract Local_09_Indexedex_Core
is
    ...
    Script_Indexedex_Uniswap_V2
{
    ...
    function setUp() public virtual {
        ...
        setOwner(deployer());
        setDeploymentPath(string.concat(LOCAL_DEPLOYMENTS_PATH, INDEXEDEX_CORE_FILE));
        ...
        vaultFeeOracleDFPkg(VaultFeeOracleDFPkg(parseJsonAddress(indexedexComponentsDeploymentJson, "vaultFeeOracleDFPkg")));
        vaultRegistryDFPkg(VaultRegistryDFPkg(parseJsonAddress(indexedexComponentsDeploymentJson, "vaultRegistryDFPkg")));
    }
