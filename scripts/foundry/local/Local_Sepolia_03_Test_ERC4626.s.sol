...
contract Local_Sepolia_03_Test_ERC4626
is
    ...
    Script_Indexedex_Uniswap_V2
{
    ...
    function setUp() public virtual {
        ...
        // balancerV3Router(IRouter(parseJsonAddress(baseDeploymentJson, "balancerV3Router")));
        ...
        tokensJSON = loadDeployments(string.concat(LOCAL_DEPLOYMENTS_PATH, BASE_TOKENS_POOLS_FILE));
        ttA = IERC20MintBurn(parseJsonAddress(tokensJSON, "TestTokenA"));
        ttB = IERC20MintBurn(parseJsonAddress(tokensJSON, "TestTokenB"));
        ttC = IERC20MintBurn(parseJsonAddress(tokensJSON, "TestTokenC"));
    }
