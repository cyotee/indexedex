...
contract Local_Sepolia_02_Test_Tokens_and_Pools_Factory_Test
is
    ...
    Script_Indexedex_Uniswap_V2
{
    ...
    string tokensPath = string.concat(DEPLOYMENT_PATH_PREFIX, SEPOLIA_DEPLOYMENTS_PATH, tokensKey, ".json");

    string erc4626JSON;
    string erc4626Key = "erc4626";
    string erc4626Path = string.concat(DEPLOYMENT_PATH_PREFIX, SEPOLIA_DEPLOYMENTS_PATH, erc4626Key, ".json");

    string uniV2PoolsJSON;
    string uniV2PoolsKey = "uniV2Pool";
    string uniV2PoolsPath = string.concat(DEPLOYMENT_PATH_PREFIX, SEPOLIA_DEPLOYMENTS_PATH, uniV2PoolsKey, ".json");

    string strategyVaultJSON;
    string strategyVaultKey = "strategyVault";
    string strategyVaultPath = string.concat(DEPLOYMENT_PATH_PREFIX, SEPOLIA_DEPLOYMENTS_PATH, strategyVaultKey, ".json");

    string rateProvidersJSON;
    string rateProvidersKey = "rateProviders";
    string rateProvidersPath = string.concat(DEPLOYMENT_PATH_PREFIX, SEPOLIA_DEPLOYMENTS_PATH, rateProvidersKey, ".json");

    string constProdPoolsJSON;
    string constProdPooolsKey = "constProdPools";
    string constProdPooolsPath = string.concat(DEPLOYMENT_PATH_PREFIX, SEPOLIA_DEPLOYMENTS_PATH, constProdPooolsKey, ".json");
    ...
    function setUp() public virtual {
        ...
        setOwner(deployer());
        setDeploymentPath(string.concat(SEPOLIA_DEPLOYMENTS_PATH, BASE_TOKENS_POOLS_FILE));
        baseDeploymentJson = loadDeployments(string.concat(SEPOLIA_DEPLOYMENTS_PATH, BASE_DEPLOYMENTS_FILE));
