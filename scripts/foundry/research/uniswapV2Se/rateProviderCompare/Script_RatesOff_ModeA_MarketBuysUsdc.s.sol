...
contract Script_RatesOff_ModeA_MarketBuysUsdc is Script {
    function run() external {
        ...
        fixture.initTelemetry("rateProviderCompare/rates_off/modeA_market_buys_usdc", true);

        console2.log("RPC Mode A rates_off: market buys USDC (WETH->USDC)");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/rates_off/modeA_market_buys_usdc/");
    }
}
