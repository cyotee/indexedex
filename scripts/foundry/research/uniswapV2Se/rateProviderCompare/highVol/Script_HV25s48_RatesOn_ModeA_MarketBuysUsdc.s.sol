...
contract Script_HV25s48_RatesOn_ModeA_MarketBuysUsdc is Script {
    ...
    function run() external {
        ...
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul25_steps48/rates_on/modeA_market_buys_usdc", true
        );

        console2.log("RPC HV25s48 Mode A rates_on: market buys USDC");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul25_steps48/rates_on/modeA_market_buys_usdc/");
    }
}
