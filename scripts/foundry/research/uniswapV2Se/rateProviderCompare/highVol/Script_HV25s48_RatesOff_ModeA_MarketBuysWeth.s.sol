...
contract Script_HV25s48_RatesOff_ModeA_MarketBuysWeth is Script {
    ...
    function run() external {
        ...
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul25_steps48/rates_off/modeA_market_buys_weth", false
        );

        console2.log("RPC HV25s48 Mode A rates_off: market buys WETH");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul25_steps48/rates_off/modeA_market_buys_weth/");
    }
}
