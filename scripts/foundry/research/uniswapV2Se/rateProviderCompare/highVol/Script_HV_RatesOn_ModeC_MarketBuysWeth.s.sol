...
contract Script_HV_RatesOn_ModeC_MarketBuysWeth is Script {
    ...
    function run() external {
        ...
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul10/rates_on/modeC_market_buys_weth", false
        );
        fixture.configureCloser();

        console2.log("RPC HV Mode C rates_on: market buys WETH + arb");
        ...
        console2.log(
            "wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul10/rates_on/modeC_market_buys_weth/"
        );
    }
}
