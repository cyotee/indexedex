...
/// @notice High-vol (mul=10) rateProviderCompare Mode A: market buys WETH. Fee unchanged.
contract Script_HV_RatesOn_ModeA_MarketBuysWeth is Script {
    uint256 internal constant MUL = 10;

    function run() external {
        ResearchFixture_RateProviderCompare fixture =
            new ResearchFixture_RateProviderCompare(true, MUL, 0);
        fixture.bootstrapResearch();
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul10/rates_on/modeA_market_buys_weth", false
        );

        console2.log("RPC HV Mode A rates_on: market buys WETH");
        console2.log("  ratesOn:", fixture.ratesOn());
        console2.log("  tradeSizeMul:", fixture.tradeSizeMul());
        console2.log("  steps:", fixture.tradeSteps());
        console2.log("  tradeUsdcWei:", fixture.tradeUsdcWei());
        ...
        console2.log(
            "wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul10/rates_on/modeA_market_buys_weth/"
        );
    }
}
