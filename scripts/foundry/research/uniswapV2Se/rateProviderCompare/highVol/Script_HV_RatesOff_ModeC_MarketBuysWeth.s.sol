...
/// @notice High-vol (mul=10) R− Mode C: market buys WETH + arb. Fee unchanged.
contract Script_HV_RatesOff_ModeC_MarketBuysWeth is Script {
    uint256 internal constant MUL = 10;

    function run() external {
        ResearchFixture_RateProviderCompare_ModeC fixture =
            new ResearchFixture_RateProviderCompare_ModeC(false, MUL, 0);
        fixture.bootstrapModeC();
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul10/rates_off/modeC_market_buys_weth", false
        );
        fixture.configureCloser();

        console2.log("RPC HV Mode C rates_off: market buys WETH + arb");
        ...
        console2.log(
            "wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul10/rates_off/modeC_market_buys_weth/"
        );
    }
}
