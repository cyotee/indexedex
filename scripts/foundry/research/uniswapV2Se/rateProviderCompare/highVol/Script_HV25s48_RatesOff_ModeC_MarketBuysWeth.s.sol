...
contract Script_HV25s48_RatesOff_ModeC_MarketBuysWeth is Script {
    uint256 internal constant MUL = 25;
    uint256 internal constant STEPS = 48;

    function run() external {
        ResearchFixture_RateProviderCompare_ModeC fixture =
            new ResearchFixture_RateProviderCompare_ModeC(false, MUL, STEPS);
        fixture.bootstrapModeC();
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul25_steps48/rates_off/modeC_market_buys_weth", false
        );
        fixture.configureCloser();

        console2.log("RPC HV25s48 Mode C rates_off: market buys WETH + arb");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul25_steps48/rates_off/modeC_market_buys_weth/");
    }
}
