...
contract Script_HV25s48_RatesOff_ModeA_MarketBuysUsdc is Script {
    uint256 internal constant MUL = 25;
    uint256 internal constant STEPS = 48;

    function run() external {
        ResearchFixture_RateProviderCompare fixture =
            new ResearchFixture_RateProviderCompare(false, MUL, STEPS);
        fixture.bootstrapResearch();
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul25_steps48/rates_off/modeA_market_buys_usdc", true
        );

        console2.log("RPC HV25s48 Mode A rates_off: market buys USDC");
        ...
        console2.log("  tradeWei:", fixture.tradeWethWei());
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul25_steps48/rates_off/modeA_market_buys_usdc/");
    }
}
