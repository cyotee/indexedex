...
/// @notice High-vol (mul=10) rateProviderCompare Mode A: market buys USDC. Fee unchanged.
contract Script_HV_RatesOn_ModeA_MarketBuysUsdc is Script {
    ...
    function run() external {
        ...
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul10/rates_on/modeA_market_buys_usdc", true
        );

        console2.log("RPC HV Mode A rates_on: market buys USDC");
        console2.log("  ratesOn:", fixture.ratesOn());
        console2.log("  tradeSizeMul:", fixture.tradeSizeMul());
        console2.log("  steps:", fixture.tradeSteps());
        console2.log("  tradeWethWei:", fixture.tradeWethWei());
        ...
        console2.log(
            "wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul10/rates_on/modeA_market_buys_usdc/"
        );
    }
}
