...
contract Script_HV_RatesOff_ModeC_MarketBuysUsdc is Script {
    ...
    function run() external {
        ...
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul10/rates_off/modeC_market_buys_usdc", true
        );
        fixture.configureCloser();

        console2.log("RPC HV Mode C rates_off: market buys USDC + arb");
        ...
        console2.log(
            "wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul10/rates_off/modeC_market_buys_usdc/"
        );
    }
}
