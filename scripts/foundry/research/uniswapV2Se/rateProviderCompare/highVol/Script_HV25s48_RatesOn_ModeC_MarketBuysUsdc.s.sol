...
contract Script_HV25s48_RatesOn_ModeC_MarketBuysUsdc is Script {
    ...
    function run() external {
        ...
        fixture.initTelemetry(
            "rateProviderCompare/highVol/mul25_steps48/rates_on/modeC_market_buys_usdc", true
        );
        fixture.configureCloser();

        console2.log("RPC HV25s48 Mode C rates_on: market buys USDC + arb");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/highVol/mul25_steps48/rates_on/modeC_market_buys_usdc/");
    }
}
