...
/// @notice rateProviderCompare pure-state Mode C: market buys USDC + arb
contract Script_RatesOff_ModeC_MarketBuysUsdc is Script {
    function run() external {
        ResearchFixture_RateProviderCompare_ModeC fixture =
            new ResearchFixture_RateProviderCompare_ModeC(false, 1, 0);
        fixture.bootstrapModeC();
        fixture.initTelemetry("rateProviderCompare/rates_off/modeC_market_buys_usdc", true);
        fixture.configureCloser();

        console2.log("RPC Mode C rates_off: market buys USDC + arb");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/rates_off/modeC_market_buys_usdc/");
    }
}
