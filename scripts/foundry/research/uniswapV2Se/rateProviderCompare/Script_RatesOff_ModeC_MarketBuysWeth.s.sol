...
contract Script_RatesOff_ModeC_MarketBuysWeth is Script {
    function run() external {
        ...
        fixture.initTelemetry("rateProviderCompare/rates_off/modeC_market_buys_weth", false);
        fixture.configureCloser();

        console2.log("RPC Mode C rates_off: market buys WETH + arb");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/rates_off/modeC_market_buys_weth/");
    }
}
