...
contract Script_RatesOn_ModeA_MarketBuysWeth is Script {
    function run() external {
        ResearchFixture_RateProviderCompare fixture =
            new ResearchFixture_RateProviderCompare(true, 1, 0);
        fixture.bootstrapResearch();
        fixture.initTelemetry("rateProviderCompare/rates_on/modeA_market_buys_weth", false);

        console2.log("RPC Mode A rates_on: market buys WETH (USDC->WETH)");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/rates_on/modeA_market_buys_weth/");
    }
}
