...
contract Script_RatesOn_ModeC_MarketBuysUsdc is Script {
    function run() external {
        ...
        fixture.initTelemetry("rateProviderCompare/rates_on/modeC_market_buys_usdc", true);
        fixture.configureCloser();

        console2.log("RPC Mode C rates_on: market buys USDC + arb");
        ...
        console2.log("wrote research/out/uniswapV2Se/rateProviderCompare/rates_on/modeC_market_buys_usdc/");
    }
}
