...
/**
 * @title Script_ModeA_TradeUsdc
 * @notice Mode A: external flow USDC→WETH on Uni. LP framing = market buys our WETH.
 ...
 * python research/plots/plot_price_series.py research/out/uniswapV2Se/modeA_trade_usdc
 * python research/plots/plot_pnl.py research/out/uniswapV2Se/modeA_trade_usdc
 * ```
 */
contract Script_ModeA_TradeUsdc is Script {
    function run() external {
        ResearchFixture_UniswapV2SeRateMatrix fixture = new ResearchFixture_UniswapV2SeRateMatrix();
        fixture.bootstrapResearch();
        // tradedIsWeth=false ⇒ trader sells USDC into pool ⇒ market buys WETH from us.
        fixture.initTelemetry("modeA_trade_usdc", false);

        console2.log("Mode A: market buys WETH from our Uni liquidity (flow: USDC -> WETH)");
        ...
        console2.log("wrote research/out/uniswapV2Se/modeA_trade_usdc/");
        console2.log("plot: python research/plots/plot_price_series.py research/out/uniswapV2Se/modeA_trade_usdc");
        console2.log("plot: python research/plots/plot_pnl.py research/out/uniswapV2Se/modeA_trade_usdc");
    }
}
