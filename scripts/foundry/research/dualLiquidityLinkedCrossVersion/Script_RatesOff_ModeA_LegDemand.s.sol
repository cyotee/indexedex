...
/// @notice DualLiquidity research Mode A rates-off: V4 common→tokenA leg demand.
contract Script_RatesOff_ModeA_LegDemand is Script {
    function run() external {
        ...
        fixture.initTelemetry("rates_off/modeA_legDemand");

        console2.log("DL Mode A rates_off: V4 common->tokenA demand");
        console2.log("  ratesOn:", fixture.ratesOn());
        console2.log("  steps:", fixture.TRADE_STEPS());
        console2.log("  tradeSize:", fixture.TRADE_SIZE());
        ...
        console2.log("wrote research/out/dualLiquidityLinkedCrossVersion/rates_off/modeA_legDemand/");
    }
}
