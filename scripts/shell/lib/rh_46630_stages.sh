# Shared 46630 Phase/Stage catalog + forge runner.
# Sourced by anvil_robinhood_testnet.sh and robinhood_testnet.sh.
...
# Catalog order: Phase 00 Stage 01, then every Stage of Phases 01–09.
rh_catalog_rows() {
  cat <<'EOF'
00 01
01 01
