...
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_00_Init.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_01_WETH9.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_02_Permit2.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_03_Balancer_V3.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_04_Uniswap_V2.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_05_Crane_Factories.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_06_Crane_Access.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_07_Crane_Components.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_08_Indexedex_Components.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_09_Indexedex_Core.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_10_Indexedex_Components_2.s.sol
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/segmented/Local_11_Indexedex_Platform.s.sol
