...
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/Local_Sepolia_01_Deploy.s.sol -vvvvv | tee Local_Sepolia_01_Deploy.log
forge script --rpc-url local --broadcast --private-key ${DEV_0_PRIVATE_KEY} --batch-size 4 scripts/foundry/local/Local_Sepolia_02_Test_Tokens_and_Pools.s.sol -vvvvv | tee Local_Sepolia_02_Test_Tokens_and_Pools.log
