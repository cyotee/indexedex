...
/**
 * @title UniswapV4WeightedSwapHook_Robinhood
 * @notice Fork DoD: factory deploy + join + swap + exit on Robinhood 4663.
 * @dev Run: forge test --match-path test/foundry/fork/robinhood_4663/hooks/uniswap/v4/weighted/** --fork-url robinhood_mainnet_alchemy
 */
contract UniswapV4WeightedSwapHook_Robinhood_Test is TestBase_UniswapV4WeightedSwapHook {
