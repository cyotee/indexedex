...
/**
 * @title AerodromeFork_ZapOut_Test
 * @notice Fork tests for Route 3: LP token to single token zap.
 ...
 */
contract AerodromeFork_ZapOut_Test is TestBase_AerodromeFork {
    /* ---------------------------------------------------------------------- */
    ...
    function test_Route3ZapOut_slippageProtection_exactMinimum() public {
        ...
        uint256 tokenOut =
            vault.exchangeIn(lpToken, lpAmount, IERC20(address(tokenA)), preview, recipient, false, _deadline());
    ...
    function test_Route3ZapOut_slippageProtection_reverts_whenMinimumTooHigh() public {
        ...
        vm.expectRevert();
        vault.exchangeIn(lpToken, lpAmount, IERC20(address(tokenA)), preview + 1, recipient, false, _deadline());
    }
    ...
    function test_Route3ZapOut_pretransferred_true() public {
        ...
        uint256 tokenOut = vault.exchangeIn(lpToken, lpAmount, IERC20(address(tokenA)), 0, recipient, true, _deadline());
