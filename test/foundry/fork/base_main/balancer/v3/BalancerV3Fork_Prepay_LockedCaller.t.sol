...
/**
 * @title BalancerV3Fork_Prepay_LockedCaller_Test
 * @notice Fork mirror of the locked-caller prepay regression test.
 * @dev Mirrors `BalancerV3StandardExchangeRouter_Prepay_LockedCaller.t.sol` but uses the Base fork fixtures.
 */
contract BalancerV3Fork_Prepay_LockedCaller_Test is TestBase_BalancerV3Fork_StrategyVault {
