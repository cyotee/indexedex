...
//         bytes4 selector = IDetf.syntheticPrice.selector;
...
//             if (selector == IDetfErrors.PoolImbalanced.selector) {
...
//         IDetf detf = IDetf(SUPERSIM_ETHEREUM_PROTOCOL_DETF);
...
//         facetAddress_ = IDiamondLoupe(SUPERSIM_ETHEREUM_PROTOCOL_DETF).facetAddress(IDetf.syntheticPrice.selector);
