...
/// @notice Combo `U6`: Morpho Blue SE Routes on a 6-dec loan token.
contract MorphoBlueStandardExchange_Routes_U6 is MorphoBlueStandardExchange_Routes_Decimals {
