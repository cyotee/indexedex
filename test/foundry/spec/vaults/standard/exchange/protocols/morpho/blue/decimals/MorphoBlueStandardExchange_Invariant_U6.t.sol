...
/// @notice Combo `U6`: Morpho Blue SE invariants on a 6-dec loan token.
contract MorphoBlueStandardExchange_Invariant_U6 is MorphoBlueStandardExchange_Invariant_Decimals {
