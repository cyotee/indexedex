...
/// @notice Combo `U9`: Morpho Blue SE interest on a 9-dec loan token.
contract MorphoBlueStandardExchange_Interest_U9 is MorphoBlueStandardExchange_Interest_Decimals {
