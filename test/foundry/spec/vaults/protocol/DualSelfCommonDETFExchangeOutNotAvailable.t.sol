 ...
 * @notice Tests that unsupported routes in BaseDualSelfCommonDETFExchangeOutTarget revert correctly.
...
contract ProtocolDETFExchangeOutNotAvailableTest is Test {
    BaseDualSelfCommonDETFExchangeOutTarget internal exchangeOut;

    function setUp() public {
        exchangeOut = new BaseDualSelfCommonDETFExchangeOutTarget();
    }
