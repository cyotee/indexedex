...
import {DualSelfCommonDETFIntegrationBase} from "./EthereumDualSelfCommonDETF_IntegrationBase.t.sol";
 ...
 */
contract ProtocolDETFDonation is DualSelfCommonDETFIntegrationBase {
    ...
    function test_donate_weth_adds_to_reserve_pool() public {
        ...
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(IERC20(address(weth9)), donationAmount, false);
        vm.stopPrank();
    ...
    function test_donate_weth_pretransferred() public {
        ...
        vm.prank(detfAlice);
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(IERC20(address(weth9)), donationAmount, true);
    ...
    function test_donate_chir_burns_supply() public {
        ...
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(IERC20(address(detf)), donationAmount, false);
        vm.stopPrank();
    ...
    function test_donate_chir_pretransferred() public {
        ...
        // Donate with pretransferred = true
        vm.prank(detfAlice);
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(IERC20(address(detf)), donationAmount, true);
    ...
    function test_donate_reverts_invalid_token() public {
        ...
        vm.expectRevert();
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(rich, donationAmount, false);
        vm.stopPrank();
    }
    ...
    function test_donate_reverts_zero_amount() public {
        vm.prank(detfAlice);
        vm.expectRevert();
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(IERC20(address(weth9)), 0, false);
    }
    ...
    function testFuzz_donate_weth(uint256 amount) public {
        ...
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(IERC20(address(weth9)), amount, false);
        vm.stopPrank();
    ...
    function testFuzz_donate_chir(uint256 chirAmount) public {
        ...
        IBaseDualSelfCommonDETFBonding(address(detf)).donate(IERC20(address(detf)), chirAmount, false);
        vm.stopPrank();
