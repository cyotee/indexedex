...
contract TestProtocolDETFBridgeHarness {
    ...
    function initBridgeConfig(DualSelfCommonDETFSuperchainBridgeRepo.BridgeConfig calldata bridgeConfig_) external {
        DualSelfCommonDETFSuperchainBridgeRepo._initialize(bridgeConfig_);
    }
        ...
        returns (IProtocolDETF.BridgeQuote memory quote)
    {
        ...
        DualSelfCommonDETFSuperchainBridgeRepo.PeerConfig memory peer = bridgeLayout.peers[targetChainId];
...
abstract contract ProtocolDETFRichBridgeSuperchainTestBase is Test {
    ...
    function _buildBridgeConfig(
        ...
        address peerRelayer
    ) internal pure returns (DualSelfCommonDETFSuperchainBridgeRepo.BridgeConfig memory bridgeConfig) {
