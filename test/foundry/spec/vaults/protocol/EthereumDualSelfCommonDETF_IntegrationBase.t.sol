...
import {
    BaseDualSelfCommonDETF_Facet_FactoryService
} from "contracts/vaults/protocol/BaseDualSelfCommonDETF_Facet_FactoryService.sol";
import {
    BaseDualSelfCommonDETF_Pkg_FactoryService
} from "contracts/vaults/protocol/BaseDualSelfCommonDETF_Pkg_FactoryService.sol";
import {
...
abstract contract DualSelfCommonDETFIntegrationBase is TestBase_BalancerV3StandardExchangeRouter {
    ...
    function setUp() public virtual override {
        ...
        IVaultFeeOracleManager(address(indexedexManager)).setDefaultBondTermsOfTypeId(
            type(IBaseDualSelfCommonDETFBonding).interfaceId,
            BondTerms({
    ...
    function _bridgePkgConfig()
        internal
        view
        returns (DualSelfCommonDETFSuperchainBridgeRepo.BridgeConfig memory bridgeConfig)
    {
        bridgeConfig = DualSelfCommonDETFSuperchainBridgeRepo.BridgeConfig({
    ...
    function _deployWeightedPool8020Factory() internal {
        ...
        address factoryAddr = create3Factory.create3WithArgs(
            ...
            initArgs,
            keccak256("EthereumDualSelfCommonDETFWeightedPool8020Factory")
        );
    ...
    function _deployRichToken() internal {
        ...
        vm.label(address(rich), "EthereumDualSelfCommonDETF_RICH");
    }
    ...
    function _deployProtocolPkgs() internal {
        ...
        IEthereumDualSelfCommonDETFDFPkg.PkgInit memory detfPkgInit =
            EthereumDualSelfCommonDETF_Component_FactoryService.buildEthereumDualSelfCommonDETFPkgInit(
                facets, infra, pkgs, _bridgePkgConfig()
            );
