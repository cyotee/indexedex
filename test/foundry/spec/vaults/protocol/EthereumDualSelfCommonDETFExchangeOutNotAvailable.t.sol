...
import {EthereumDualSelfCommonDETFExchangeOutTarget} from "contracts/vaults/protocol/EthereumDualSelfCommonDETFExchangeOutTarget.sol";

/**
 * @title ProtocolDETFExchangeOutNotAvailableTest
 * @notice Tests that unsupported routes in EthereumDualSelfCommonDETFExchangeOutTarget revert correctly.
...
contract ProtocolDETFExchangeOutNotAvailableTest is Test {
    EthereumDualSelfCommonDETFExchangeOutTarget internal exchangeOut;

    function setUp() public {
        exchangeOut = new EthereumDualSelfCommonDETFExchangeOutTarget();
    }
