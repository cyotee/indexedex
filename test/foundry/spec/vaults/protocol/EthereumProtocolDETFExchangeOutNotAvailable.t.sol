...
import {EthereumProtocolDETFExchangeOutTarget} from "contracts/vaults/protocol/EthereumProtocolDETFExchangeOutTarget.sol";

/**
 * @title ProtocolDETFExchangeOutNotAvailableTest
 * @notice Tests that unsupported routes in EthereumProtocolDETFExchangeOutTarget revert correctly.
...
contract ProtocolDETFExchangeOutNotAvailableTest is Test {
    EthereumProtocolDETFExchangeOutTarget internal exchangeOut;

    function setUp() public {
        exchangeOut = new EthereumProtocolDETFExchangeOutTarget();
    }
