...
import {
    IBaseDualSelfCommonDETFDFPkg
} from "contracts/vaults/protocol/BaseDualSelfCommonDETFDFPkg.sol";
import {
...
abstract contract DualSelfCommonDETFIntegrationBase is TestBase_BalancerV3StandardExchangeRouter {
    ...
    function _deployProtocolPkgs() internal {
        IFacet protocolDETFExchangeInFacet = create3Factory.deployBaseDualSelfCommonDETFExchangeInFacet();
        IFacet protocolDETFExchangeInQueryFacet = create3Factory.deployBaseDualSelfCommonDETFExchangeInQueryFacet();
        IFacet protocolDETFExchangeOutFacet = create3Factory.deployBaseDualSelfCommonDETFExchangeOutFacet();
        IFacet protocolDETFBondingFacet = create3Factory.deployBaseDualSelfCommonDETFBondingFacet();
        ...
        IFacet protocolDETFRichirRedeemFacet = create3Factory.deployBaseDualSelfCommonDETFRichirRedeemFacet();
        ...
        BaseDualSelfCommonDETF_Component_FactoryService.ProtocolDETFFacets memory facets;
        ...
        BaseDualSelfCommonDETF_Component_FactoryService.ProtocolDETFInfra memory infra =
            BaseDualSelfCommonDETF_Component_FactoryService.ProtocolDETFInfra({
        ...
        BaseDualSelfCommonDETF_Component_FactoryService.ProtocolDETFPkgs memory pkgs =
            BaseDualSelfCommonDETF_Component_FactoryService.ProtocolDETFPkgs({
        ...
        IBaseDualSelfCommonDETFDFPkg.PkgInit memory detfPkgInit =
            BaseDualSelfCommonDETF_Component_FactoryService.buildProtocolDETFPkgInit(facets, infra, pkgs, _bridgePkgConfig());

        vm.startPrank(owner);
        protocolDETFDFPkg = IVaultRegistryDeployment(address(indexedexManager)).deployBaseDualSelfCommonDETFDFPkg(detfPkgInit);
        vm.stopPrank();
    }
    ...
    function _registerProtocolPkgs() internal {
        ...
        assertTrue(
            ...
            "BaseDualSelfCommonDETFDFPkg not registered"
        );
    }
    ...
    function _deployProtocolDetf() internal {
        ...
        IBaseDualSelfCommonDETFDFPkg.PkgArgs memory pkgArgs;
