...
import {DualSelfCommonDETFIntegrationBase} from "./DualSelfCommonDETF_IntegrationBase.t.sol";
 ...
 */
contract ProtocolDETFRichirRedeem_Test is DualSelfCommonDETFIntegrationBase {
    /* ---------------------------------------------------------------------- */
    /*                         Exchange Tests                                   */
    /* ---------------------------------------------------------------------- */
    ...
    function test_richir_to_rich_redeem_when_allowed() public {
        ...
        (uint256 tokenId,) = IBaseDualSelfCommonDETFBonding(address(detf)).bond(
        ...
        vm.startPrank(detfAlice);
        IBaseDualSelfCommonDETFBonding(address(detf)).sellNFT(tokenId, detfAlice);
        vm.stopPrank();
        ...
        vm.prank(owner);
        IBaseDualSelfCommonDETFRichirRedeem(address(detf)).addAllowedRichirRedeemAddress(detfAlice);
        assertTrue(IBaseDualSelfCommonDETFRichirRedeem(address(detf)).isAllowedRichirRedeemAddress(detfAlice));
    ...
    function test_richir_to_rich_redeem_reverts_when_not_allowed() public {
        ...
        vm.startPrank(detfAlice);
        richir.approve(address(detf), richirBalance);
        vm.expectRevert(abi.encodeWithSelector(BaseDualSelfCommonDETFRepo.NotAllowedRichirRedeem.selector, detfAlice));
    ...
    function test_richir_to_rich_redeem_reverts_after_removal() public {
        ...
        IBaseDualSelfCommonDETFRichirRedeem(address(detf)).addAllowedRichirRedeemAddress(detfAlice);
        vm.prank(owner);
        IBaseDualSelfCommonDETFRichirRedeem(address(detf)).removeAllowedRichirRedeemAddress(detfAlice);
    ...
    function test_addAllowedAddress_byOwner_succeeds() public {
        ...
        IBaseDualSelfCommonDETFRichirRedeem(address(detf)).addAllowedRichirRedeemAddress(detfAlice);
        assertTrue(
            IBaseDualSelfCommonDETFRichirRedeem(address(detf)).isAllowedRichirRedeemAddress(detfAlice),
    ...
    function test_addAllowedAddress_multipleAddresses() public {
        ...
        IBaseDualSelfCommonDETFRichirRedeem(address(detf)).addAllowedRichirRedeemAddress(detfAlice);
        vm.prank(owner);
        IBaseDualSelfCommonDETFRichirRedeem(address(detf)).addAllowedRichirRedeemAddress(detfBob);
        ...
        assertTrue(
            IBaseDualSelfCommonDETFRichirRedeem(address(detf)).isAllowedRichirRedeemAddress(detfBob),
    ...
    function test_isAllowedAddress_returnsCorrectValue() public {
        ...
        assertFalse(
            IBaseDualSelfCommonDETFRichirRedeem(address(detf)).isAllowedRichirRedeemAddress(address(0)),
    ...
    function test_removeAllowedAddress_nonExistent_succeeds() public {
        ...
        vm.prank(owner);
        IBaseDualSelfCommonDETFRichirRedeem(address(detf)).removeAllowedRichirRedeemAddress(detfBob);
