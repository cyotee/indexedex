...
import {
    ...
    IMultiVaultInvHost_Decimals
} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/multi-vault-weighted/decimals/invariant/Handler_MultiVaultWeightedDetf_Decimals.sol";
...
abstract contract MultiVaultWeightedDetfInvariant_Decimals is TestBase_MultiVaultWeightedDetf_Decimals, IMultiVaultInvHost_Decimals {
    ...
    function setUp() public virtual override {
        ...
        handler = new Handler_MultiVaultWeightedDetf(IMultiVaultInvHost_Decimals(address(this)));
