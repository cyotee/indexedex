...
/**
 * @title SingleStandardExchangeDETF_Alignment_FeeCreatorClaim
 * @notice D28 FC1–FC12 on the production Single SE proxy.
 */
contract SingleStandardExchangeDETF_Alignment_FeeCreatorClaim is TestBase_SingleStandardExchangeDETF {
    function setUp() public override {
        super.setUp();
        detf = _deployOpenModeDetf("FC Single SE", "fcSSE");
    ...
    function test_FC1_singleSe_feeToAndCreatorCanClaim() public {
    ...
    function test_FC2_singleSe_claimEqualsPendingAndBalance() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        _liveMint(alice, 200e18);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC3_singleSe_dueAmountsFloor() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC4_singleSe_newSharesDoNotClaimOldPot() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        _liveMint(alice, 200e18);
        IDETFNFTVault nft_ = _nft();
        ...
        // buyClaim can accrue 1-wei-scale rps dust; new shares must not inherit the old pot.
    ...
    function test_FC5_singleSe_newPotAtNewWeights() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        IDETFNFTVault nft_ = _nft();
        uint256 F_ = nft_.effectiveSharesOf(DETF_FEE_TO_BOND_NFT_ID);
        uint256 T_ = nft_.totalShares();
    ...
    function test_FC6_singleSe_secondClaimZero() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        _liveMint(alice, 200e18);
    ...
    function test_FC7_singleSe_nonOwnerCannotClaim() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        _liveMint(alice, 200e18);
        IDETFNFTVault nft_ = _nft();
        vm.prank(alice);
    ...
    function test_FC8_singleSe_ids1and2CannotSellOrClose() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
    ...
    function test_FC9_singleSe_d2NoOriginalShares() public {
    ...
    function test_FC10_singleSe_feeToChangeDoesNotMoveId1() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        _liveMint(alice, 200e18);
    ...
    function test_FC11_singleSe_creatorZeroFeeToOwnsBoth() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        _liveMint(alice, 200e18);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC12_singleSe_conservationTwoWaves() public {
        _bootstrapViaFirstBond(alice, 2_000e18);
        _liveMint(alice, 200e18);
        _bootstrapViaFirstBond(bob, 400e18);
    ...
    function _liveMint(address who_, uint256 seLp_) internal {
        uint256 shares_ = _fundSeShares(who_, seLp_);
        vm.startPrank(who_);
        seShare.approve(detf, shares_);
        IStandardExchangeIn(detf).exchangeIn(
            seShare, shares_, IERC20(detf), 0, who_, false, block.timestamp + 1 hours
        );
        vm.stopPrank();
    }
}
