...
import {MixedBufferMultiVaultStableDetf_PriceShift_Test} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/mixedBuffer/MixedBufferMultiVaultStableDetf_PriceShift.t.sol";
...
abstract contract MixedBufferMultiVaultStableDetf_PriceShift_Decimals is
    MixedBufferMultiVaultStableDetf_PriceShift_Test, TestBase_MixedBufferMultiVaultStableDetf_Decimals
{
    function setUp() public virtual override(MixedBufferMultiVaultStableDetf_PriceShift_Test, TestBase_MixedBufferMultiVaultStableDetf) {
        MixedBufferMultiVaultStableDetf_PriceShift_Test.setUp();
    }
