...
import {MixedBufferMultiVaultStableDetf_NestedPush_Test} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/mixedBuffer/MixedBufferMultiVaultStableDetf_NestedPush.t.sol";
...
abstract contract MixedBufferMultiVaultStableDetf_NestedPush_Decimals is
    MixedBufferMultiVaultStableDetf_NestedPush_Test, TestBase_MixedBufferMultiVaultStableDetf_Decimals
{
    function setUp() public virtual override(MixedBufferMultiVaultStableDetf_NestedPush_Test, TestBase_MixedBufferMultiVaultStableDetf) {
        MixedBufferMultiVaultStableDetf_NestedPush_Test.setUp();
    }
