...
import {MixedBufferMultiVaultStableDetf_Burn_Test} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/mixedBuffer/MixedBufferMultiVaultStableDetf_Burn.t.sol";
...
abstract contract MixedBufferMultiVaultStableDetf_Burn_Decimals is
    MixedBufferMultiVaultStableDetf_Burn_Test, TestBase_MixedBufferMultiVaultStableDetf_Decimals
{
    function setUp() public virtual override(MixedBufferMultiVaultStableDetf_Burn_Test, TestBase_MixedBufferMultiVaultStableDetf) {
        MixedBufferMultiVaultStableDetf_Burn_Test.setUp();
    }
