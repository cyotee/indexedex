...
import {MixedBufferMultiVaultStableDetf_Reentrancy_Test} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/mixedBuffer/MixedBufferMultiVaultStableDetf_Reentrancy.t.sol";
...
abstract contract MixedBufferMultiVaultStableDetf_Reentrancy_Decimals is MixedBufferMultiVaultStableDetf_Reentrancy_Test, TestBase_MixedBufferMultiVaultStableDetf_Decimals {
    function setUp() public virtual override(MixedBufferMultiVaultStableDetf_Reentrancy_Test, TestBase_MixedBufferMultiVaultStableDetf) {
        MixedBufferMultiVaultStableDetf_Reentrancy_Test.setUp();
    }
