...
import {MixedBufferMultiVaultStableDetf_Routes_Test} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/mixedBuffer/MixedBufferMultiVaultStableDetf_Routes.t.sol";
...
abstract contract MixedBufferMultiVaultStableDetf_Routes_Decimals is
    MixedBufferMultiVaultStableDetf_Routes_Test, TestBase_MixedBufferMultiVaultStableDetf_Decimals
{
    function setUp() public virtual override(MixedBufferMultiVaultStableDetf_Routes_Test, TestBase_MixedBufferMultiVaultStableDetf) {
        MixedBufferMultiVaultStableDetf_Routes_Test.setUp();
    }
