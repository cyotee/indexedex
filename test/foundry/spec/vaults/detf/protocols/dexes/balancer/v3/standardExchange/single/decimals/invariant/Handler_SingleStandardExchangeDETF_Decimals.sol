...
interface ISingleSeDetfInvHost_Decimals {
...
contract Handler_SingleStandardExchangeDETF_Decimals is Test {
    ISingleSeDetfInvHost_Decimals public immutable HOST;
    ...
    constructor(ISingleSeDetfInvHost_Decimals host_) {
        HOST = host_;
    }
