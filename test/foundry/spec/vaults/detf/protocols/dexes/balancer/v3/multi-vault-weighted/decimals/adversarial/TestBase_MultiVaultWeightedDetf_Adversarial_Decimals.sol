...
contract AdvRecordingReentrantShare_WtdDec is MockERC20 {
...
contract AdvReentryTarget_WtdDec {
...
/// @title TestBase_MultiVaultWeightedDetf_Adversarial_Decimals
...
abstract contract TestBase_MultiVaultWeightedDetf_Adversarial_Decimals is TestBase_MultiVaultWeightedDetf_Decimals {
    address internal attacker;
    address internal victim;

    AdvRecordingReentrantShare_WtdDec internal hostileShare;
    AdvReentryTarget_WtdDec internal reentryTarget;

    function setUp() public virtual override {
        super.setUp();
        attacker = makeAddr("attacker");
        victim = makeAddr("victim");
        hostileShare = new AdvRecordingReentrantShare_WtdDec();
        reentryTarget = new AdvReentryTarget_WtdDec();
