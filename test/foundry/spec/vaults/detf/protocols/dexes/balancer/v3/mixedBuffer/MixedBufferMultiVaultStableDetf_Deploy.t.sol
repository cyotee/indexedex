...
contract MixedBufferMultiVaultStableDetf_Deploy_Test is TestBase_MixedBufferMultiVaultStableDetf {
    function test_deploy_inert_n1() public virtual {
        _assertInert(detf);
        ...
        assertEq(detfInfo.bufferToken(), address(_fixtureBufferToken()), "buffer");
        ...
        assertEq(IDiamondLoupe(detf).facetAddress(bytes4(keccak256("thresholdMode()"))), address(0));
        ...
        assertEq(address(pool_.bufferToken()), address(_fixtureBufferToken()), "pool buffer");
        assertEq(IERC20(detfInfo.reservePool()).totalSupply(), 0, "pool not initialized");
    }

    function test_deploy_n2() public virtual {
    ...
    function test_deploy_n3_smoke() public virtual {
    ...
    function test_deploy_reverts_invalid_vault_count_zero() public virtual {
        IMixedBufferMultiVaultStableDetfDFPkg.PkgArgs memory args;
        args.name = "bad";
        args.symbol = "bad";
        args.bufferToken = IERC20(address(_fixtureBufferToken()));
    ...
    function test_deploy_reverts_duplicate_vault() public virtual {
        IMixedBufferMultiVaultStableDetfDFPkg.PkgArgs memory args;
        args.name = "dup";
        args.symbol = "dup";
        args.bufferToken = IERC20(address(_fixtureBufferToken()));
    ...
    function test_deploy_reverts_bad_amp() public virtual {
    ...
    function test_deploy_reverts_rp_length_mismatch() public virtual {
        IMixedBufferMultiVaultStableDetfDFPkg.PkgArgs memory args = _buildPkgArgs(1, 0, 0);
    ...
    function test_deploy_via_registry_not_new() public virtual {
