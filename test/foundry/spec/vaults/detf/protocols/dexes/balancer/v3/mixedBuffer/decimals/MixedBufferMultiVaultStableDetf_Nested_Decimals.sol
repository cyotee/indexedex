...
import {MixedBufferMultiVaultStableDetf_Nested_Test} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/mixedBuffer/MixedBufferMultiVaultStableDetf_Nested.t.sol";
...
abstract contract MixedBufferMultiVaultStableDetf_Nested_Decimals is
    MixedBufferMultiVaultStableDetf_Nested_Test, TestBase_MixedBufferMultiVaultStableDetf_Decimals
{
    function setUp() public virtual override(MixedBufferMultiVaultStableDetf_Nested_Test, TestBase_MixedBufferMultiVaultStableDetf) {
        MixedBufferMultiVaultStableDetf_Nested_Test.setUp();
    }
