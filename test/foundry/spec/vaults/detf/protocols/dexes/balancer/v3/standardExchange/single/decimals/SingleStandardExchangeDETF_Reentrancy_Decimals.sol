...
contract RecordingReentrantShare_BalV3StaSin is MockERC20 {
...
contract DetfReentryTarget_BalV3StaSin {
...
abstract contract SingleStandardExchangeDETF_Reentrancy_Decimals is TestBase_SingleStandardExchangeDETF_Decimals {
    RecordingReentrantShare_BalV3StaSin internal hostileShare;
    DetfReentryTarget_BalV3StaSin internal reentryTarget;
    ...
    function setUp() public virtual override {
        ...
        hostileShare = new RecordingReentrantShare_BalV3StaSin();
        reentryTarget = new DetfReentryTarget_BalV3StaSin();
    ...
    function test_reentrancy_mintSharePath_nestedHitsIsLocked() public {
        ...
        bytes memory reentry = abi.encodeCall(
            DetfReentryTarget_BalV3StaSin.reenterExchangeIn,
    ...
    function test_reentrancy_crossFunction_bond_nestedHitsIsLocked() public {
        uint256 amountIn_ = 50e18;
        bytes memory reentry = abi.encodeCall(
            DetfReentryTarget_BalV3StaSin.reenterBond,
