...
import {MixedBufferMultiVaultStableDetf_Mint_Test} from "test/foundry/spec/vaults/detf/protocols/dexes/balancer/v3/mixedBuffer/MixedBufferMultiVaultStableDetf_Mint.t.sol";
...
abstract contract MixedBufferMultiVaultStableDetf_Mint_Decimals is
    MixedBufferMultiVaultStableDetf_Mint_Test, TestBase_MixedBufferMultiVaultStableDetf_Decimals
{
    function setUp() public virtual override(MixedBufferMultiVaultStableDetf_Mint_Test, TestBase_MixedBufferMultiVaultStableDetf) {
        MixedBufferMultiVaultStableDetf_Mint_Test.setUp();
    }
