...
interface IMultiVaultInvHost_Decimals {
 ...
 */
contract Handler_MultiVaultWeightedDetf_Decimals is Test {
    IMultiVaultInvHost_Decimals public immutable HOST;
    ...
    constructor(IMultiVaultInvHost_Decimals host_) {
        HOST = host_;
    }
