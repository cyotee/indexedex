...
/// @notice M-QD-P1P2G4 money paths: pons v1 + pons v2 + generic V4.
contract UniswapV4Detf_Quad_PonsMix is TestBase_UniswapV4Detf_Quad_PonsMix {
    function test_M_QD_P1P2G4_firstBond() public {
    ...
    function test_M_QD_P1P2G4_mint() public {
    ...
    function test_M_QD_P1P2G4_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_M_QD_P1P2G4_close() public {
