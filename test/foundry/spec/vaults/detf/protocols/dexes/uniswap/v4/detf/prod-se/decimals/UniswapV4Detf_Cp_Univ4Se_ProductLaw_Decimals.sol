...
abstract contract UniswapV4Detf_Cp_Univ4Se_ProductLaw_Decimals is
    ...
    UniswapV4Detf_Stage11OpenSuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Cp_Univ4Se_Decimals, UniswapV4Detf_Stage11OpenSuite_Decimals)
    {
