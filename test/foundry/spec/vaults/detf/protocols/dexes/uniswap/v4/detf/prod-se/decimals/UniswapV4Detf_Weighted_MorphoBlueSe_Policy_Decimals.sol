...
abstract contract UniswapV4Detf_Weighted_MorphoBlueSe_Policy_Decimals is
    ...
    UniswapV4Detf_Stage11PolicySuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Weighted_MorphoBlueSe_Decimals, UniswapV4Detf_Stage11PolicySuite_Decimals)
    {
