...
/// @notice M-WE-MBGV4 money paths: firstBond / mint / burn / close (Morpho pair0 + Uni V4 pair1).
contract UniswapV4Detf_Weighted_MorphoMix is TestBase_UniswapV4Detf_Weighted_MorphoMix {
    function test_M_WE_MBGV4_firstBond() public {
    ...
    function test_M_WE_MBGV4_mint() public {
    ...
    function test_M_WE_MBGV4_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_M_WE_MBGV4_close() public {
