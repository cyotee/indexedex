...
contract WeightedHostilePairToken is SimpleMintableERC20 {
    ...
    constructor() SimpleMintableERC20("HostilePairW", "HPAIRW") {}
...
/**
 * @title UniswapV4Detf_Weighted_Adversarial_Reentrancy
 * @notice Weighted gold mint reentrancy during pair transferFrom hits IsLocked.
 */
contract UniswapV4Detf_Weighted_Adversarial_Reentrancy is TestBase_UniswapV4Detf_Weighted_Adversarial {
    WeightedHostilePairToken internal hostilePair;
    ...
    function setUp() public override {
        ...
        _fundActor(hostileDetf, detfUser, 10_000 ether);
