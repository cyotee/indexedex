...
/// @notice H-QD-MB money paths: firstBond / mint / burn / close against three Morpho Blue SEs.
contract UniswapV4Detf_Quad_MorphoBlueSe is TestBase_UniswapV4Detf_Quad_MorphoBlueSe {
    function test_H_QD_MB_firstBond() public {
    ...
    function test_H_QD_MB_mint() public {
    ...
    function test_H_QD_MB_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_H_QD_MB_close() public {
