...
/// @notice H-OR-GV4 money paths: firstBond / mint / burn / close against two Uni V4 SEs.
contract UniswapV4Detf_Orbital_Univ4Se is TestBase_UniswapV4Detf_Orbital_Univ4Se {
    function test_H_OR_GV4_firstBond() public {
    ...
    function test_H_OR_GV4_mint() public {
    ...
    function test_H_OR_GV4_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_H_OR_GV4_close() public {
