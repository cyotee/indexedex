...
abstract contract UniswapV4Detf_Weighted_PonsV2Se_ProductLaw_Decimals is
    ...
    UniswapV4Detf_Stage11OpenSuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Weighted_PonsV2Se_Decimals, UniswapV4Detf_Stage11OpenSuite_Decimals)
    {
    ...
    /// @dev Pons v2 launch tokens are not MintableERC20Decimals; adjust supply with deal.
