...
/// @notice H_OR_GV4 Stage 11 Open (§7.0). Layer abstracts only (R-24).
contract UniswapV4Detf_Orbital_Univ4Se_ProductLaw is
    TestBase_UniswapV4Detf_Orbital_Univ4Se,
    UniswapV4Detf_Stage11OpenSuite
{
    function setUp()
        public
        override(TestBase_UniswapV4Detf_Orbital_Univ4Se, UniswapV4Detf_Stage11OpenSuite)
    {
