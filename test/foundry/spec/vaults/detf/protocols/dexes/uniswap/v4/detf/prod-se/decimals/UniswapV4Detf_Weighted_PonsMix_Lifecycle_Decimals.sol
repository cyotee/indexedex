...
import {TestBase_UniswapV4Detf_Weighted_PonsMix_Decimals} from
    "contracts/vaults/detf/protocols/dexes/uniswap/v4/detf/TestBase_UniswapV4Detf_Weighted_PonsMix_Decimals.sol";

abstract contract UniswapV4Detf_Weighted_PonsMix_Lifecycle_Decimals is TestBase_UniswapV4Detf_Weighted_PonsMix_Decimals {
    ...
    function test_H_WE_PonsMix_firstBond() public {
    ...
    function test_H_WE_PonsMix_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_WE_PonsMix_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_WE_PonsMix_close() public {
