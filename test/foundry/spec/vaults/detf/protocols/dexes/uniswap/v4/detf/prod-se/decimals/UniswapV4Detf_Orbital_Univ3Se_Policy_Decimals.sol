...
abstract contract UniswapV4Detf_Orbital_Univ3Se_Policy_Decimals is
    ...
    UniswapV4Detf_Stage11PolicySuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Orbital_Univ3Se_Decimals, UniswapV4Detf_Stage11PolicySuite_Decimals)
    {
