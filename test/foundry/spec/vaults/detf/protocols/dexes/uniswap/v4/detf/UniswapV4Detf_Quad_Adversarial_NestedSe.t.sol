...
import {Adversarial_NestedSe} from
    "test/foundry/spec/vaults/detf/protocols/dexes/uniswap/v4/detf/adversarial/Adversarial_NestedSe.t.sol";

/// @notice Quad gold T-NEST-1..3 + T-LOCAL-I1 against bound SE (se0).
contract UniswapV4Detf_Quad_Adversarial_NestedSe is
