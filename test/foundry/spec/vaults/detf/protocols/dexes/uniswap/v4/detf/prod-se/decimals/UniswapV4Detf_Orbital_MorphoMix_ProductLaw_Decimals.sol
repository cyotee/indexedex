...
abstract contract UniswapV4Detf_Orbital_MorphoMix_ProductLaw_Decimals is
    ...
    UniswapV4Detf_Stage11OpenSuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Orbital_MorphoMix_Decimals, UniswapV4Detf_Stage11OpenSuite_Decimals)
    {
