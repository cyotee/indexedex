...
contract CurvePretransferHelper {
...
/// @notice Catalog I1–I3 on the production curve-quad DETF proxy.
contract Adversarial_CurveQuad_TrustFlags is TestBase_UniswapV4StandardExchangeCurveQuadStableDETF {
    CurvePretransferHelper internal preHelper;
    address internal attacker;
    address internal victim;

    function setUp() public override {
        super.setUp();
        preHelper = new CurvePretransferHelper();
    ...
    function test_I1_pretransferred_bond_inventoryNoInCallTransfer_revertsDelta0() public {
        ...
        IUniswapV4StandardExchangeCurveQuadStableDETF(instance_).bond(
    ...
    function test_I1_pretransferred_depositClaim_inventoryNoInCallTransfer_revertsDelta0() public {
        ...
        IUniswapV4StandardExchangeCurveQuadStableDETF(instance_).depositClaim(
