...
import {TestBase_UniswapV4Detf_Weighted_Univ4Se_Decimals} from
    "contracts/vaults/detf/protocols/dexes/uniswap/v4/detf/TestBase_UniswapV4Detf_Weighted_Univ4Se_Decimals.sol";
...
abstract contract UniswapV4Detf_Weighted_Univ4Se_ProductLaw_Decimals is
    TestBase_UniswapV4Detf_Weighted_Univ4Se_Decimals,
    UniswapV4Detf_Stage11OpenSuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Weighted_Univ4Se_Decimals, UniswapV4Detf_Stage11OpenSuite_Decimals)
    {
        TestBase_UniswapV4Detf_Weighted_Univ4Se_Decimals.setUp();
