...
/// @notice H_WE_P1 Stage 11 Open (§7.0). Layer abstracts only (R-24).
contract UniswapV4Detf_Weighted_PonsV1Se_ProductLaw is
    TestBase_UniswapV4Detf_Weighted_PonsV1Se,
    UniswapV4Detf_Stage11OpenSuite
{
    function setUp()
        public
        override(TestBase_UniswapV4Detf_Weighted_PonsV1Se, UniswapV4Detf_Stage11OpenSuite)
    {
