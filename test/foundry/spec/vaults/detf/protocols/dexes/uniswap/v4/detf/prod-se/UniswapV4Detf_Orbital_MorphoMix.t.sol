...
/// @notice M-OR-MBGV4 money paths: firstBond / mint / burn / close (Morpho pair0 + G-V4 pair1).
contract UniswapV4Detf_Orbital_MorphoMix is TestBase_UniswapV4Detf_Orbital_MorphoMix {
    function test_M_OR_MBGV4_firstBond() public {
    ...
    function test_M_OR_MBGV4_mint() public {
    ...
    function test_M_OR_MBGV4_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_M_OR_MBGV4_close() public {
