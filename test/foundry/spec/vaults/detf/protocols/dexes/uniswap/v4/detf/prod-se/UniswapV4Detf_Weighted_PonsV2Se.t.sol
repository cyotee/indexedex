...
/// @notice H-WE-P2 money paths: firstBond / mint / burn / close against two pons v2 Uni V4 SE.
contract UniswapV4Detf_Weighted_PonsV2Se is TestBase_UniswapV4Detf_Weighted_PonsV2Se {
    function test_H_WE_P2_firstBond() public {
    ...
    function test_H_WE_P2_mint() public {
    ...
    function test_H_WE_P2_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_H_WE_P2_close() public {
