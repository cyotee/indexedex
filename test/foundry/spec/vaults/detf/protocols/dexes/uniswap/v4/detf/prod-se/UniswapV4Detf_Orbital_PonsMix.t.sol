...
/// @notice M-OR-P1P2 money paths: firstBond / mint / burn / close (pons v1 + pons v2).
contract UniswapV4Detf_Orbital_PonsMix is TestBase_UniswapV4Detf_Orbital_PonsMix {
    function test_M_OR_P1P2_firstBond() public {
    ...
    function test_M_OR_P1P2_mint() public {
    ...
    function test_M_OR_P1P2_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_M_OR_P1P2_close() public {
