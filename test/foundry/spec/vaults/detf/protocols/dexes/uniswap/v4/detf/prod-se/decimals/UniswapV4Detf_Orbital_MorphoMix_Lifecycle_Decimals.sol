...
abstract contract UniswapV4Detf_Orbital_MorphoMix_Lifecycle_Decimals is TestBase_UniswapV4Detf_Orbital_MorphoMix_Decimals {
    ...
    function test_H_OR_Mix_firstBond() public {
    ...
    function test_H_OR_Mix_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_OR_Mix_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_OR_Mix_close() public {
