...
abstract contract UniswapV4Detf_Orbital_MorphoBlueSe_Lifecycle_Decimals is TestBase_UniswapV4Detf_Orbital_MorphoBlueSe_Decimals {
    ...
    function test_H_OR_MB_firstBond() public {
    ...
    function test_H_OR_MB_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_OR_MB_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_OR_MB_close() public {
