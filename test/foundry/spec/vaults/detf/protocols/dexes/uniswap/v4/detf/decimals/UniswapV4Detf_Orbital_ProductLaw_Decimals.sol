...
abstract contract UniswapV4Detf_Orbital_ProductLaw_Decimals is
    TestBase_UniswapV4Detf_Orbital_Decimals,
    UniswapV4Detf_Stage11OpenSuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Orbital_Decimals, UniswapV4Detf_Stage11OpenSuite_Decimals)
    {
        TestBase_UniswapV4Detf_Orbital_Decimals.setUp();
    ...
    function _firstBond(uint256 pairAmount_)
        internal
        virtual
        override(TestBase_UniswapV4Detf_Decimals, TestBase_UniswapV4Detf_Orbital_Decimals)
        returns (uint256 tokenId, uint256 shares)
    {
        return TestBase_UniswapV4Detf_Orbital_Decimals._firstBond(pairAmount_);
    }
    ...
    function _assertNoJoinableDust()
        ...
        override(TestBase_UniswapV4Detf_Decimals, TestBase_UniswapV4Detf_Orbital_Decimals)
    {
        TestBase_UniswapV4Detf_Orbital_Decimals._assertNoJoinableDust();
    }
}
