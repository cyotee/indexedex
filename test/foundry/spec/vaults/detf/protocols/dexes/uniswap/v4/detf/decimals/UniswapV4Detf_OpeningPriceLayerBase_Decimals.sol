...
import {UniswapV4Detf_OpeningPriceBase_Decimals} from
    "test/foundry/spec/vaults/detf/protocols/dexes/uniswap/v4/detf/decimals/UniswapV4Detf_OpeningPriceBase_Decimals.sol";

/**
 * @title UniswapV4Detf_OpeningPriceLayerBase
 * @notice T1/T2/T5 only (gold + Stage 11 Policy). T6 is Weighted/Quad later WPs.
 */
abstract contract UniswapV4Detf_OpeningPriceLayerBase_Decimals is UniswapV4Detf_OpeningPriceBase_Decimals {
