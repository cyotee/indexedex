...
abstract contract UniswapV4Detf_Orbital_PonsV2Se_Lifecycle_Decimals is TestBase_UniswapV4Detf_Orbital_PonsV2Se_Decimals {
    ...
    function test_H_OR_P2_firstBond() public {
    ...
    function test_H_OR_P2_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_OR_P2_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_OR_P2_close() public {
