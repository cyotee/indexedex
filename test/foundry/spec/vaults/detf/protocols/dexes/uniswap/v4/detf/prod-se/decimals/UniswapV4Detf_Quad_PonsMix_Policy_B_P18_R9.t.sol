...
import {UniswapV4Detf_Quad_PonsMix_Policy_Decimals} from
    "test/foundry/spec/vaults/detf/protocols/dexes/uniswap/v4/detf/prod-se/decimals/UniswapV4Detf_Quad_PonsMix_Policy_Decimals.sol";

/// @notice Combo `B_P18_R9`. pair/launch 18-dec; other configurable leg 9-dec. vaultShare / detfToken stay 18.
contract UniswapV4Detf_Quad_PonsMix_Policy_B_P18_R9 is UniswapV4Detf_Quad_PonsMix_Policy_Decimals {
