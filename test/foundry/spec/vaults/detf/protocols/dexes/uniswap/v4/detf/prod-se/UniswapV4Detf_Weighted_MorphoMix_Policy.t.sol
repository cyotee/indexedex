...
import {TestBase_UniswapV4Detf_Weighted_MorphoMix} from
    "contracts/vaults/detf/protocols/dexes/uniswap/v4/detf/TestBase_UniswapV4Detf_Weighted_MorphoMix.sol";
...
/// @notice M_WE_MorphoMix Stage 11 Policy (§7.0). FC names use fixture id (R-16).
contract UniswapV4Detf_Weighted_MorphoMix_Policy is
    TestBase_UniswapV4Detf_Weighted_MorphoMix,
    UniswapV4Detf_Stage11PolicySuite
{
    function setUp()
        public
        override(TestBase_UniswapV4Detf_Weighted_MorphoMix, UniswapV4Detf_Stage11PolicySuite)
    {
        TestBase_UniswapV4Detf_Weighted_MorphoMix.setUp();
    ...
    function test_FC1_univ4Detf_M_WE_MorphoMix_feeToAndCreatorCanClaim() public { _assertFC1(); }
    function test_FC2_univ4Detf_M_WE_MorphoMix_claimEqualsPendingAndBalance() public { _assertFC2(); }
    function test_FC3_univ4Detf_M_WE_MorphoMix_dueAmountsFloor() public { _assertFC3(); }
    function test_FC4_univ4Detf_M_WE_MorphoMix_newSharesDoNotClaimOldPot() public { _assertFC4(); }
    function test_FC5_univ4Detf_M_WE_MorphoMix_newPotAtNewWeights() public { _assertFC5(); }
    function test_FC6_univ4Detf_M_WE_MorphoMix_secondClaimZero() public { _assertFC6(); }
    function test_FC7_univ4Detf_M_WE_MorphoMix_nonOwnerCannotClaim() public { _assertFC7(); }
    function test_FC8_univ4Detf_M_WE_MorphoMix_ids1and2CannotSellOrClose() public { _assertFC8(); }
    function test_FC9_univ4Detf_M_WE_MorphoMix_d2NoOriginalShares() public { _assertFC9(); }
    function test_FC10_univ4Detf_M_WE_MorphoMix_feeToChangeDoesNotMoveId1() public { _assertFC10(); }
    function test_FC11_univ4Detf_M_WE_MorphoMix_creatorZeroFeeToOwnsBoth() public { _assertFC11(); }
    function test_FC12_univ4Detf_M_WE_MorphoMix_conservationTwoWaves() public { _assertFC12(); }
