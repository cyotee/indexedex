...
import {TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals} from
    "contracts/vaults/detf/protocols/dexes/uniswap/v4/detf/TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals.sol";
...
abstract contract UniswapV4Detf_Orbital_PonsV1Se_ProductLaw_Decimals is
    TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals,
    UniswapV4Detf_Stage11OpenSuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals, UniswapV4Detf_Stage11OpenSuite_Decimals)
    {
        TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals.setUp();
    ...
    function _fundBondLegFallback(address token_, address to_, uint256 amount_)
        internal
        virtual
        override(TestBase_UniswapV4Detf_Decimals, TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals)
    {
        TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals._fundBondLegFallback(token_, to_, amount_);
    }
}
