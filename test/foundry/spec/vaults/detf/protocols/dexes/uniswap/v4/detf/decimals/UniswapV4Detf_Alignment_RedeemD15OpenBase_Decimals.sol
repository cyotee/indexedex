...
abstract contract UniswapV4Detf_Alignment_RedeemD15OpenBase_Decimals is UniswapV4Detf_ClaimBase_Decimals {
    ...
    function test_D15_1_previewEqualsExecute() public virtual {
        uint256 claimBal_ = _sellAndClaimOn(detf, detfUser, _uPair(100), _uPair(10));
