...
abstract contract UniswapV4Detf_Weighted_PonsMix_ProductLaw_Decimals is
    TestBase_UniswapV4Detf_Weighted_PonsMix_Decimals,
    UniswapV4Detf_Stage11OpenSuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Weighted_PonsMix_Decimals, UniswapV4Detf_Stage11OpenSuite_Decimals)
    {
        TestBase_UniswapV4Detf_Weighted_PonsMix_Decimals.setUp();
