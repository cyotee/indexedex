...
/**
 * @title Adversarial_Surface
 * @notice J1–J3: Target/interface ⊆ facetFuncs ⊆ loupe; smoke on the proxy, never the facet impl.
 * @dev Product selectors include IDetf.claimLiquidity (0xcaaf4702) and previewClaimLiquidity.
 *      DONATE owns the cut; this suite does not add those functions to production CODE.
 */
contract Adversarial_Surface is TestBase_UniswapV4Detf_Adversarial {
    ...
    function test_J3_proxyCallable_smoke_eachSelector() public {
        ...
        // Donate preview of DETF is the live join path. Pair-share join preview may
        // revert UnsupportedRoute on the hook (same as previewMint share comment).
