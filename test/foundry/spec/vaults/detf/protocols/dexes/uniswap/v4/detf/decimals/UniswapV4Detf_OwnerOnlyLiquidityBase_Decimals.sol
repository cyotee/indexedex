...
/// @notice Gold owner-only liquidity asserts (PRD §7.7). No setUp deploy.
abstract contract UniswapV4Detf_OwnerOnlyLiquidityBase_Decimals is TestBase_UniswapV4Detf_Decimals {
