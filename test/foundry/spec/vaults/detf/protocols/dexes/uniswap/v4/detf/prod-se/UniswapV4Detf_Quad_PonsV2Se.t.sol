...
/// @notice H-QD-P2 money paths: firstBond / mint / burn / close against three pons v2 Uni V4 SEs.
contract UniswapV4Detf_Quad_PonsV2Se is TestBase_UniswapV4Detf_Quad_PonsV2Se {
    function test_H_QD_P2_firstBond() public {
    ...
    function test_H_QD_P2_mint() public {
    ...
    function test_H_QD_P2_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_H_QD_P2_close() public {
