 ...
 * @dev Stage 11 must inherit UniswapV4Detf_PolicyLayerBase_Decimals, not this gold-full abstract (R-24).
 */
abstract contract UniswapV4Detf_PolicyBase_Decimals is TestBase_UniswapV4Detf_Policy_Decimals {
