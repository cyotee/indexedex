...
abstract contract UniswapV4Detf_Weighted_MorphoMix_Lifecycle_Decimals is TestBase_UniswapV4Detf_Weighted_MorphoMix_Decimals {
    ...
    function test_H_WE_Mix_firstBond() public {
    ...
    function test_H_WE_Mix_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_WE_Mix_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_WE_Mix_close() public {
