...
/// @notice H_OR_GV3 Stage 11 Open (§7.0). Layer abstracts only (R-24).
contract UniswapV4Detf_Orbital_Univ3Se_ProductLaw is
    TestBase_UniswapV4Detf_Orbital_Univ3Se,
    UniswapV4Detf_Stage11OpenSuite
{
    function setUp()
        public
        override(TestBase_UniswapV4Detf_Orbital_Univ3Se, UniswapV4Detf_Stage11OpenSuite)
    {
