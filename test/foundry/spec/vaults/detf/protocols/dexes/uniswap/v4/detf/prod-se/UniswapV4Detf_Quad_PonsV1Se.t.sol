...
/// @notice H-QD-P1 money paths: firstBond / mint / burn / close against three pons v1 Uni V3 SEs.
contract UniswapV4Detf_Quad_PonsV1Se is TestBase_UniswapV4Detf_Quad_PonsV1Se {
    function test_H_QD_P1_firstBond() public {
    ...
    function test_H_QD_P1_mint() public {
    ...
    function test_H_QD_P1_burn() public {
        _firstBond(100 ether);
        vm.startPrank(detfUser);
    ...
    function test_H_QD_P1_close() public {
