...
/// @notice Weighted gold FC1–FC12. Copied CP bodies with `_weighted_` names (R-16). Do not inherit `test_FC*_cp_*`.
contract UniswapV4Detf_Weighted_Alignment_FeeCreatorClaim is
    ...
    UniswapV4Detf_ClaimBase
{
    ...
    function test_FC1_univ4Detf_weighted_feeToAndCreatorCanClaim() public {
        _bootAlice(20 ether);
    ...
    function test_FC2_univ4Detf_weighted_claimEqualsPendingAndBalance() public {
        _bootAlice(20 ether);
        _liveMintOn(detf, alice, 2 ether);
        IDETFNFTVault nft_ = _nft();
        address feeTo_ = _feeToOf(detf);
    ...
    function test_FC3_univ4Detf_weighted_dueAmountsFloor() public {
        _bootAlice(20 ether);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC4_univ4Detf_weighted_newSharesDoNotClaimOldPot() public {
        _bootAlice(20 ether);
        _liveMintOn(detf, alice, 2 ether);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC5_univ4Detf_weighted_newPotAtNewWeights() public {
        _bootAlice(20 ether);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC6_univ4Detf_weighted_secondClaimZero() public {
        _bootAlice(20 ether);
        _liveMintOn(detf, alice, 2 ether);
        address feeTo_ = _feeToOf(detf);
    ...
    function test_FC7_univ4Detf_weighted_nonOwnerCannotClaim() public {
        _bootAlice(20 ether);
        _liveMintOn(detf, alice, 2 ether);
        IDETFNFTVault nft_ = _nft();
        vm.prank(alice);
    ...
    function test_FC8_univ4Detf_weighted_ids1and2CannotSellOrClose() public {
        _bootAlice(20 ether);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC9_univ4Detf_weighted_d2NoOriginalShares() public {
        _bootAlice(15 ether);
        IDETFNFTVault nft_ = _nft();
    ...
    function test_FC10_univ4Detf_weighted_feeToChangeDoesNotMoveId1() public {
        _bootAlice(20 ether);
        _liveMintOn(detf, alice, 2 ether);
    ...
    function test_FC11_univ4Detf_weighted_creatorZeroFeeToOwnsBoth() public {
        _fcActors();
    ...
    function test_FC12_univ4Detf_weighted_conservationTwoWaves() public {
        _bootAlice(20 ether);
        _liveMintOn(detf, alice, 2 ether);
