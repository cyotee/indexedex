...
/**
 * @title Adversarial_Weighted_A0Crops
 * @notice A0 first-bond residual + CROPS disable-on-exit.
 */
contract Adversarial_Weighted_A0Crops is TestBase_UniswapV4StandardExchangeWeightedDETF {
    ...
    function test_A0_preLive_donatePair_pretransferredBond_cannotMintFromResidual() public {
        ...
        assertEq(IERC20(p0_).balanceOf(instance_), donate_, "donation sitting");
    ...
    function test_A0_preLive_pullFalse_doesNotCreditDonation() public {
        ...
        assertGe(IERC20(p0_).balanceOf(instance_), donate_, "donation leftover after pull-false go-live");
    }
    ...
    function test_CROPS_disable_doesNotBlock_closeBondMature_or_redeemClaim() public {
        ...
        uint256 depIn_ = 20 ether;
        uint256 claimOut_ = info_.depositClaim(IERC20(p0_), depIn_, 0, detfUser, false, _dl());
        vm.stopPrank();
        assertGt(claimOut_, 0, "claim minted");
