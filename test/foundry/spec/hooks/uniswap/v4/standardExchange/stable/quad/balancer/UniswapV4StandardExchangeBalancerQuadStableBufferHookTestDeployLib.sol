...
library UniswapV4StandardExchangeBalancerQuadStableBufferHookTestDeployLib {
    struct VaultFacets {
        IFacet erc20Facet;
        IFacet erc5267Facet;
        IFacet erc2612Facet;
    ...
    function deployFactoryAndPackage(
        ...
        returns (
            ...
            IUniswapV4StandardExchangeBalancerQuadStableBufferHookPackage hookPkg
        )
    {
    ...
    function _buildPkgInit(
        ...
        private
        returns (IUniswapV4StandardExchangeBalancerQuadStableBufferHookPackage.PkgInit memory init)
    {
