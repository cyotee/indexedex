...
/// @notice Combo `P18_R6` is illegal under HDEC-7: CP raw/self-leg decimals must be 18.
contract UniswapV4SingleStandardExchangeBufferConstantProductHook_P18_R6 is TestBase {
    function test_HDEC7_rawTokenDecimals6_reverts() public {
        IPkg.PkgArgs memory args = _defaultPkgArgs();
        args.rawTokenDecimals = 6;
