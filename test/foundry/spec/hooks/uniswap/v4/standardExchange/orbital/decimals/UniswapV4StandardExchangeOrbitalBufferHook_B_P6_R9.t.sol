...
/// @notice Book `B_P6_R9`. pairToken=token0 6-dec; token1 9; token2 9. After PoolKey sort roles stay token0/1/2.
contract UniswapV4StandardExchangeOrbitalBufferHook_B_P6_R9 is
