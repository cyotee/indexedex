...
/**
 * @title UniswapV4CurveQuadStableSwapHook_Reentrancy_Test
 ...
 */
contract UniswapV4CurveQuadStableSwapHook_Reentrancy_Test is TestBase_UniswapV4CurveQuadStableSwapHook {
    ...
    function test_A1_reentrancy_addLiquidity() public {
        ...
        (address h, IUniswapV4CurveQuadStableSwapHook q) = _deployWithHostilePull(hostile, "add");
    ...
    function test_A1_reentrancy_zapIn() public {
        HostilePullToken hostile = new HostilePullToken("H", "H", 18);
        (address h, IUniswapV4CurveQuadStableSwapHook q) = _deployWithHostilePull(hostile, "zap");
    ...
    function test_A1_reentrancy_removeLiquidity() public {
        ...
        (address h, IUniswapV4CurveQuadStableSwapHook q) = _deployWithHostilePush(hostile, "rm");
