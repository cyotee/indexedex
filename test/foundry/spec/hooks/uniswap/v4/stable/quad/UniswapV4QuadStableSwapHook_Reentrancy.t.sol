...
/**
 * @title UniswapV4QuadStableSwapHook_Reentrancy_Test
 ...
 */
contract UniswapV4QuadStableSwapHook_Reentrancy_Test is TestBase_UniswapV4QuadStableSwapHook {
    ...
    function test_A1_reentrancy_addLiquidity() public {
        ...
        (address h, IUniswapV4QuadStableSwapHook q) = _deployWithHostilePull(hostile, "add");
        ...
        hostile.arm(
            ...
            abi.encodeWithSelector(
                IUniswapV4QuadStableSwapHook.addLiquidity.selector, amounts, mins, user, uint256(0)
            )
        );
    ...
    function test_A1_reentrancy_zapIn() public {
        HostilePullToken hostile = new HostilePullToken("H", "H", 18);
        (address h, IUniswapV4QuadStableSwapHook q) = _deployWithHostilePull(hostile, "zap");
        ...
        hostile.arm(
            h, abi.encodeWithSelector(IUniswapV4QuadStableSwapHook.zapIn.selector, zapAmts, user, uint256(0))
        );
    ...
    function test_A1_reentrancy_removeLiquidity() public {
        ...
        (address h, IUniswapV4QuadStableSwapHook q) = _deployWithHostilePush(hostile, "rm");
        ...
        hostile.arm(
            h,
            abi.encodeWithSelector(
                IUniswapV4QuadStableSwapHook.removeLiquidity.selector, sh / 2, user, minOut
            )
        );
    ...
    function _deployWithHostilePull(HostilePullToken hostile, string memory tag)
        internal
        returns (address h, IUniswapV4QuadStableSwapHook q)
    {
        ...
        q = IUniswapV4QuadStableSwapHook(h);
