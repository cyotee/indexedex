...
/**
 * @title UniswapV4BalancerQuadStableSwapHook_Safety_Test
 * @notice CL ban, donate ban, wrong init keys, donation pricing.
 */
contract UniswapV4BalancerQuadStableSwapHook_Safety_Test is TestBase_UniswapV4BalancerQuadStableSwapHook {
