...
contract UniswapV4CurveQuadStableSwapHook_Factory_Test is TestBase_UniswapV4CurveQuadStableSwapHook {
    ...
    function test_F2_deployWithMineNonce() public {
        ...
        IUniswapV4CurveQuadStableSwapHookPackage.PkgArgs memory args2 =
    ...
    function _findBadMineNonce(IUniswapV4CurveQuadStableSwapHookPackage.PkgArgs memory args)
        internal
        returns (uint256 bad)
    {
    ...
    function test_F4_unsorted_reverts() public {
        address[4] memory providers;
        IUniswapV4CurveQuadStableSwapHookPackage.PkgArgs memory bad = _pkgArgs(
            address(t3), address(t2), address(t1), address(t0), DEMO_FEE, DEMO_AMP, providers
        );
        vm.expectRevert(IUniswapV4CurveQuadStableSwapHookPackage.InvalidTokenOrder.selector);
    ...
    function test_F5_zeroFee_reverts() public {
        ...
        address[4] memory providers;
        IUniswapV4CurveQuadStableSwapHookPackage.PkgArgs memory bad =
            _pkgArgs(toks[0], toks[1], toks[2], toks[3], 0, DEMO_AMP, providers);
        vm.expectRevert(IUniswapV4CurveQuadStableSwapHookPackage.InvalidFee.selector);
        hookPkg.processArgs(abi.encode(bad));
    }
    ...
    function test_F5_zeroAmp_reverts() public {
        ...
        vm.expectRevert(IUniswapV4CurveQuadStableSwapHookPackage.InvalidAmp.selector);
        hookPkg.processArgs(abi.encode(bad));
    }
    ...
    function test_F8_rateProviders_in_salt() public {
        ...
        IUniswapV4CurveQuadStableSwapHookPackage.PkgArgs memory a0 =
            _pkgArgs(toks[0], toks[1], toks[2], toks[3], DEMO_FEE, DEMO_AMP, pZero);
        IUniswapV4CurveQuadStableSwapHookPackage.PkgArgs memory a1 =
