...
/**
 * @title UniswapV4CurveQuadStableSwapHook_Liquidity_Test
 * @notice First mint, later mint, remove, mixed decimals, donation ignore.
 */
contract UniswapV4CurveQuadStableSwapHook_Liquidity_Test is TestBase_UniswapV4CurveQuadStableSwapHook {
