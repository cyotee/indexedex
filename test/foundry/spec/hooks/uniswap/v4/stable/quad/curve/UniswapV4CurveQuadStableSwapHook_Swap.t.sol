...
/**
 * @title UniswapV4CurveQuadStableSwapHook_Swap_Test
 * @notice All six pairs exact-in/out both directions; preview fidelity; inert SwapNotLive.
 */
contract UniswapV4CurveQuadStableSwapHook_Swap_Test is TestBase_UniswapV4CurveQuadStableSwapHook {
    WrapperExactOutRouter internal swapRouter;

    function setUp() public override {
        TestBase_UniswapV4CurveQuadStableSwapHook.setUp();
