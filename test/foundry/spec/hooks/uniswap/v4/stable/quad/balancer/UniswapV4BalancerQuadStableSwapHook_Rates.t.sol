...
/**
 * @title UniswapV4BalancerQuadStableSwapHook_Rates_Test
 * @notice Rate scale + fail-closed providers (D74).
 */
contract UniswapV4BalancerQuadStableSwapHook_Rates_Test is TestBase_UniswapV4BalancerQuadStableSwapHook {
