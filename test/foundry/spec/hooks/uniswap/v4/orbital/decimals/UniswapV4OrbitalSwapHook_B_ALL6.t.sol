...
/// @notice Book `B_ALL6`. pairToken=token0 6-dec; token1 6; token2 6. After PoolKey sort roles stay token0/1/2.
contract UniswapV4OrbitalSwapHook_B_ALL6 is UniswapV4OrbitalSwapHook_Decimals {
