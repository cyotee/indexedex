...
/// @notice Book `B_P9_R6`. pairToken=token0 9-dec; token1 6; token2 18. After PoolKey sort roles stay token0/1/2.
contract UniswapV4OrbitalSwapHook_B_P9_R6 is UniswapV4OrbitalSwapHook_Decimals {
