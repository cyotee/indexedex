...
/// @notice Book `B_P18_R9`. pairToken=token0 18-dec; token1 9; token2 18. After PoolKey sort roles stay token0/1/2.
contract UniswapV4OrbitalSwapHook_B_P18_R9 is UniswapV4OrbitalSwapHook_Decimals {
