...
import {
    EthereumDualSelfCommonDETF_Component_FactoryService
} from "contracts/vaults/protocol/EthereumDualSelfCommonDETF_Component_FactoryService.sol";
import {
    EthereumDualSelfCommonDETF_Facet_FactoryService
} from "contracts/vaults/protocol/EthereumDualSelfCommonDETF_Facet_FactoryService.sol";
...
import {
    IEthereumDualSelfCommonDETFDFPkg,
    EthereumDualSelfCommonDETFDFPkg
} from "contracts/vaults/protocol/EthereumDualSelfCommonDETFDFPkg.sol";
import {
    EthereumDualSelfCommonDETF_Pkg_FactoryService
...
contract EthereumDualSelfCommonDETFDFPkg_Deploy_Test is TestBase_BalancerV3StandardExchangeRouter {
    ...
    using EthereumDualSelfCommonDETF_Pkg_FactoryService for IVaultRegistryDeployment;
    ...
    function setUp() public override {
        ...
        IVaultFeeOracleManager(address(indexedexManager))
            .setDefaultDexSwapFeeOfTypeId(type(IBaseDualSelfCommonDETFBonding).interfaceId, DEFAULT_SWAP_FEE);
        vm.stopPrank();
    }

    function _deployWeightedPool8020Factory() internal {
        bytes32 salt = keccak256("EthereumDualSelfCommonDETFWeightedPool8020Factory");
        ...
        vm.label(factoryAddr, "EthereumDualSelfCommonDETFWeightedPool8020Factory");
    }
    ...
    function _deployStandardExchangeRateProviderPkg() internal {
        IFacet rateProviderFacet = IFacet(
            create3Factory.deployFacet(
                ...
                keccak256("EthereumDualSelfCommonDETF_StandardExchangeRateProviderFacet")
            )
        );
        vm.label(address(rateProviderFacet), "EthereumDualSelfCommonDETF_StandardExchangeRateProviderFacet");
        ...
        rateProviderPkg = IStandardExchangeRateProviderDFPkg(
            address(
                create3Factory.deployPackageWithArgs(
                    ...
                    abi.encode(pkgInit),
                    keccak256("EthereumDualSelfCommonDETF_StandardExchangeRateProviderDFPkg")
                )
            )
        );
        vm.label(address(rateProviderPkg), "EthereumDualSelfCommonDETF_StandardExchangeRateProviderDFPkg");
    }
        ...
        richTokenPkg = IERC20PermitDFPkg(
            address(
                create3Factory.deployPackageWithArgs(
                    ...
                    abi.encode(pkgInit),
                    keccak256("EthereumDualSelfCommonDETF_RichTokenPkg")
                )
            )
        );
        vm.label(address(richTokenPkg), "EthereumDualSelfCommonDETF_RichTokenPkg");
    }
    ...
    function _deployRichToken() internal {
        ...
        vm.label(richAddr, "EthereumDualSelfCommonDETF_RICH");
    }
    ...
    function _deployProtocolPkgs() internal {
        IFacet protocolDETFExchangeInFacet = create3Factory.deployEthereumDualSelfCommonDETFExchangeInFacet();
        IFacet protocolDETFExchangeInQueryFacet = create3Factory.deployEthereumDualSelfCommonDETFExchangeInQueryFacet();
        IFacet protocolDETFExchangeOutFacet = create3Factory.deployEthereumDualSelfCommonDETFExchangeOutFacet();
        IFacet protocolDETFBondingFacet = create3Factory.deployEthereumDualSelfCommonDETFBondingFacet();
        ...
        IProtocolNFTVaultDFPkg.PkgInit memory nftPkgInit = BaseDualSelfCommonDETF_Component_FactoryService.buildProtocolNFTVaultPkgInit(
            erc721Facet,
            erc4626BasicVaultFacet,
            erc4626StandardVaultFacet,
        ...
        EthereumDualSelfCommonDETF_Component_FactoryService.EthereumDualSelfCommonDETFFacets memory facets =
            EthereumDualSelfCommonDETF_Component_FactoryService.EthereumDualSelfCommonDETFFacets({
                erc20Facet: erc20Facet,
                erc5267Facet: erc5267Facet,
                erc2612Facet: erc2612Facet,
        ...
        EthereumDualSelfCommonDETF_Component_FactoryService.EthereumDualSelfCommonDETFInfra memory infra =
            EthereumDualSelfCommonDETF_Component_FactoryService.EthereumDualSelfCommonDETFInfra({
        ...
        EthereumDualSelfCommonDETF_Component_FactoryService.EthereumDualSelfCommonDETFPkgs memory pkgs =
            EthereumDualSelfCommonDETF_Component_FactoryService.EthereumDualSelfCommonDETFPkgs({
        ...
        IEthereumDualSelfCommonDETFDFPkg.PkgInit memory detfPkgInit =
            EthereumDualSelfCommonDETF_Component_FactoryService.buildEthereumDualSelfCommonDETFPkgInit(
                facets, infra, pkgs, bridgeConfig
            );

        vm.startPrank(owner);
        protocolDETFDFPkg = IVaultRegistryDeployment(address(indexedexManager)).deployEthereumDualSelfCommonDETFDFPkg(detfPkgInit);
        vm.stopPrank();

        assertGt(address(protocolDETFDFPkg).code.length, 0, "EthereumDualSelfCommonDETFDFPkg not deployed");
    }
    ...
    function _registerProtocolPkgs() internal {
        ...
        assertTrue(
            ...
            "EthereumDualSelfCommonDETFDFPkg not registered"
        );
    }
    ...
    function test_deployVault_success() public {
        ...
        IEthereumDualSelfCommonDETFDFPkg.PkgArgs memory pkgArgs;
        pkgArgs.name = "Ethereum Protocol DETF";
        pkgArgs.symbol = "eCHIR";
        pkgArgs.funder = owner;
        pkgArgs.protocolConfig = BaseDualSelfCommonDETFRepo.ProtocolConfig({
    ...
    function test_processArgs_reverts_whenNotRegistry() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IEthereumDualSelfCommonDETFDFPkg.NotCalledByRegistry.selector, address(this)));
    ...
    function _deployStandaloneChirToken(uint256 totalSupply, address recipient) internal returns (IERC20 chirToken) {
        IERC20PermitDFPkg.PkgArgs memory args = IERC20PermitDFPkg.PkgArgs({
            ...
            recipient: recipient,
            optionalSalt: keccak256("EthereumDualSelfCommonDETF_StandaloneCHIR")
        });
        ...
        vm.label(chirAddr, "EthereumDualSelfCommonDETF_StandaloneCHIR");
    }
}