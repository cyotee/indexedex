...
/**
 * @title EtherFiWeETHStandardExchange_Fees_Test
 * @notice Usage fee + liquid % oracle resolution smoke.
 */
contract EtherFiWeETHStandardExchange_Fees_Test is TestBase_EtherFiWeETHStandardExchange {
    function test_F1_usageFee_mintsSharesToFeeTo() public {
        bytes4 typeId = type(IEtherFiWeETHStandardVault).interfaceId;
    ...
    function test_F3_liquidPct_resolves20PercentDefault() public view {
        assertEq(
