...
contract MockTokenDescriptorFr_Dec {
    function tokenURI(uint256) external pure returns (string memory) {
        return "";
    }
}

/// @notice Full-range book. pairToken = tokenA. Amounts are raw units via `_u0`/`_u1`.
abstract contract UniswapV3StandardExchange_FullRangeBook_Decimals is TestBase_UniswapV3StandardExchange_Decimals {
    ...
    function setUp() public virtual override {
        ...
        npm = new NonfungiblePositionManager(
            address(uniswapV3Factory), address(1), address(new MockTokenDescriptorFr_Dec())
        );
    }
    ...
    function test_FR4_blockedJoin_thenIdleRebalance_sameFullRangeTicks() public {
        ...
        address t0 = _token0();
        _mint(t0, address(lockCaller), blockedIn);
    ...
    function testFuzz_singleDeposit_roundTripPreservesIncumbentValue(bool token1_) public {
        ...
        _mint(address(asset), depositor, amount);
    ...
    function test_FR5_bothTokensActivateThenSingleTokenDepositsRemainAvailable() public {
        ...
        _mint(address(input), address(this), amount);
    ...
    function test_FR6_importedNftConvertedToFullRange() public {
        ...
        _mint(token0, address(this), _u0(20));
        _mint(token1, address(this), _u1(20));
        IERC20(token0).approve(address(npm), _u0(20));
        IERC20(token1).approve(address(npm), _u1(20));
        (uint256 tokenId,,,) = npm.mint(
            INonfungiblePositionManager.MintParams({
                ...
                amount0Desired: _u0(20),
                amount1Desired: _u1(20),
                amount0Min: 0,
                amount1Min: 0,
