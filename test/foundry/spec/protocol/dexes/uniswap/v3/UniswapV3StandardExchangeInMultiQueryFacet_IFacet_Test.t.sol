...
contract UniswapV3StandardExchangeInMultiQueryFacet_IFacet_Test is CraneTest, TestBase_IFacet {
    ...
    function facetTestInstance() public override returns (IFacet) {
        return create3Factory.deployUniswapV3StandardExchangeInMultiQueryFacet();
    }
