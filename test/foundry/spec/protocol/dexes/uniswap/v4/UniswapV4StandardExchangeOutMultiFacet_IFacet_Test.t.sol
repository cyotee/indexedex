...
contract UniswapV4StandardExchangeOutMultiFacet_IFacet_Test is CraneTest, TestBase_IFacet {
    ...
    function facetTestInstance() public override returns (IFacet) {
        return create3Factory.deployUniswapV4StandardExchangeOutMultiFacet();
    }

    function controlFacetName() public pure override returns (string memory) {
        return type(UniswapV4StandardExchangeOutMultiFacet).name;
    }
    ...
    function controlFacetFuncs() public pure override returns (bytes4[] memory controlFuncs) {
        ...
        controlFuncs[0] = IStandardExchangeOutMulti.exchangeOutOneToMany.selector;
    }
}
