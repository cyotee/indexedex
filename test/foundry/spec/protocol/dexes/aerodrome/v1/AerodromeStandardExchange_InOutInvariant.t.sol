...
/**
 * @title AerodromeStandardExchange_InOutInvariant
...
contract AerodromeStandardExchange_InOutInvariant is TestBase_AerodromeStandardExchange_MultiPool {
    /* ---------------------------------------------------------------------- */
    /*                               Helpers                                   */
    /* ---------------------------------------------------------------------- */
    ...
    function test_route1_previewInOutInverse_forward() public {
        ...
        assertGe(Xprime, amountIn - 1, "Route1: X' must be within -1 of X");
    ...
    function test_route1_exchangeOut_matchesPreview() public {
        IStandardExchangeProxy vault = _getVault(PoolConfig.Balanced);
        IPool pool = _getPool(PoolConfig.Balanced);
        (ERC20PermitMintableStub tokenAStub, ERC20PermitMintableStub tokenBStub) = _getTokens(PoolConfig.Balanced);
        IERC20 tokenIn = IERC20(pool.token0());
        IERC20 tokenOut = IERC20(pool.token1());
        ERC20PermitMintableStub tokenInStub = address(tokenAStub) == pool.token0() ? tokenAStub : tokenBStub;
    ...
    function testFuzz_route1_inOutInvariant(uint256 amountIn) public {
        ...
        uint256 Xprime = vault.previewExchangeOut(tokenIn, tokenOut, Y);
        // Allow ±2 wei for integer rounding.
    ...
    function test_route2_previewInOutInverse_forward() public {
        ...
        assertGe(Xprime, amountIn - 1, "Route2: X' >= X-1");
    ...
    function testFuzz_route2_inOutInvariant(uint256 amountIn) public {
        ...
        // Lower bound 1e16: avoids tiny-deposit fallback; upper bound reserveIn/100.
    ...
    function test_route3_previewInOutInverse_forward() public {
        ...
        // ZapOut inverse overestimates LP; allow up to 1%.
    ...
    function test_route5_previewInOutInverse_forward() public {
        ...
        // Both sides use _convertToShares[Down/Up]; allow 1 wei tolerance.
    ...
    function testFuzz_route5_inOutInvariant(uint256 sharesIn) public {
        ...
        assertGe(Xprime, sharesIn, "Fuzz Route5: X' >= X");
        assertLe(Xprime, sharesIn + 1, "Fuzz Route5: X' within 1 wei of X");
    }
