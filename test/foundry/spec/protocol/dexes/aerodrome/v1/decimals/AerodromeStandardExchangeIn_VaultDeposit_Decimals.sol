...
/**
 * @title AerodromeStandardExchangeIn_VaultDeposit_Decimals
 ...
 */
abstract contract AerodromeStandardExchangeIn_VaultDeposit_Decimals is TestBase_AerodromeStandardExchange_Decimals {
    /* ---------------------------------------------------------------------- */
