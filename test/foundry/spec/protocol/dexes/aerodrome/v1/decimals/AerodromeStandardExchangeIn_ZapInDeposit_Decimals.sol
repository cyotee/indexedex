...
/**
 * @title AerodromeStandardExchangeIn_ZapInDeposit_Decimals
 ...
 */
abstract contract AerodromeStandardExchangeIn_ZapInDeposit_Decimals is TestBase_AerodromeStandardExchange_Decimals {
    /* ---------------------------------------------------------------------- */
    ...
    function _boundAmount(IPool pool, MintableERC20Decimals tokenIn, uint256 amountIn)
        internal
        view
        returns (uint256)
    {
