...
/**
 * @title AerodromeStandardExchangeIn_Swap_Decimals
 ...
 */
abstract contract AerodromeStandardExchangeIn_Swap_Decimals is TestBase_AerodromeStandardExchange_Decimals {
    ...
    function _test_previewVsMath(PoolConfig config, bool aToB) internal view {
        ...
        uint256 amountIn = _testAmt(aToB ? tokenA : tokenB);
    ...
    function _boundSwapAmount(IPool pool, MintableERC20Decimals tokenIn, uint256 amountIn)
        internal
        view
        returns (uint256)
    {
