...
/**
 * @title AerodromeStandardExchangeIn_VaultWithdraw_Decimals
 * @notice Tests for Route 5: Vault shares to LP token withdrawal.
 * @dev Route 5 handles withdrawals where tokenIn is the vault itself and tokenOut is the LP token.
 *      Burns vault shares and returns LP tokens to the recipient.
 */
abstract contract AerodromeStandardExchangeIn_VaultWithdraw_Decimals is TestBase_AerodromeStandardExchange_Decimals {
    /* ---------------------------------------------------------------------- */
    /*                              Setup Helper                              */
    /* ---------------------------------------------------------------------- */
