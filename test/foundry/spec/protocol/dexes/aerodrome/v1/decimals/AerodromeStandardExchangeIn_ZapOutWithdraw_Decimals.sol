...
/**
 * @title AerodromeStandardExchangeIn_ZapOutWithdraw_Decimals
 ...
 *      a single token.
 */
abstract contract AerodromeStandardExchangeIn_ZapOutWithdraw_Decimals is TestBase_AerodromeStandardExchange_Decimals {
    /* ---------------------------------------------------------------------- */
    /*                              Setup Helper                              */
    /* ---------------------------------------------------------------------- */
    ...
    function _test_execVsPreview(PoolConfig config, bool toTokenA) internal {
        ...
        uint256 shares = _seedVaultWithShares(config, _testAmt(tokenA));
    ...
    function test_Route7ZapOutWithdraw_fullWithdrawal_balanced() public {
        ...
        // Seed vault
        uint256 shares = _seedVaultWithShares(PoolConfig.Balanced, _uA(1000));
