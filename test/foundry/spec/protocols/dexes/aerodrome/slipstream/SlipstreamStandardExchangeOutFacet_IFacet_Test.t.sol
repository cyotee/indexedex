...
/**
 * @title SlipstreamStandardExchangeOutFacet_IFacet_Test
 * @notice Validates SlipstreamStandardExchangeOutFacet exposes correct interfaces and selectors
 * @author cyotee doge <doge.cyotee>
 */
contract SlipstreamStandardExchangeOutFacet_IFacet_Test is CraneTest, TestBase_IFacet {
    ...
    function facetTestInstance() public override returns (IFacet) {
        return create3Factory.deploySlipstreamStandardExchangeOutFacet();
    }
