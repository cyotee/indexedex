 ...
 */
abstract contract StandardExchangeBufferPoolTargetTest_Decimals is TestBase_StandardExchangeBufferPool_Decimals {
    ...
    function test_onSwap_hookSharesDeltaShiftsDerivedY() public {
        ...
        // 6-dec TTA scaling makes WeightedMath vs CP diverge by ~1e11 scaled18 wei
        // (still < 1 native 6-dec unit = 1e12 scaled18).
        assertApproxEqAbs(out, 7.272727272727272727e18, 1e12);
    }
