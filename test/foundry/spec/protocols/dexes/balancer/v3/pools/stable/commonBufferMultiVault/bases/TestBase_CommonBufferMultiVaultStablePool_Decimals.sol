 ...
 */
abstract contract TestBase_CommonBufferMultiVaultStablePool_Decimals is TestBase_StandardExchangeBufferPool_Decimals {
    ...
    function _initPool() internal virtual override {
        ...
        uint256 bufAmt = _from18(address(buffer), CBMVS_INIT_BUFFER);
        uint256 shareSeed = CBMVS_INIT_SHARES;
        ...
        returns (uint256 sharesOut)
    {
        ...
        // `_from18` here minted too few shares and router.initialize reverted TransferFromFailed.
