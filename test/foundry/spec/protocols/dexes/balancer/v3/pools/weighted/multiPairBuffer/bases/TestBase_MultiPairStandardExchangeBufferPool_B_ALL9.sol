...
abstract contract TestBase_MultiPairStandardExchangeBufferPool_B_ALL9 is TestBase_MultiPairStandardExchangeBufferPool_Decimals {
    ...
    function _restDecimals() internal pure override returns (uint8) { return 9; }
}
