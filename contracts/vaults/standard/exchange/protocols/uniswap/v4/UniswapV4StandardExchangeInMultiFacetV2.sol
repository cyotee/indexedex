...
import {
    UniswapV4StandardExchangeInMultiTargetV2
} from "contracts/vaults/standard/exchange/protocols/uniswap/v4/UniswapV4StandardExchangeInMultiTargetV2.sol";

contract UniswapV4StandardExchangeInMultiFacetV2 is UniswapV4StandardExchangeInMultiTargetV2, IFacet {
    function facetName() public pure override returns (string memory name) {
        return type(UniswapV4StandardExchangeInMultiFacetV2).name;
    }
