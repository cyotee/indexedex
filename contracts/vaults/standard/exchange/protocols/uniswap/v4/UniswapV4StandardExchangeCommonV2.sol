...
import {UniswapV4QuoteServiceV2} from "contracts/vaults/standard/exchange/protocols/uniswap/v4/UniswapV4QuoteServiceV2.sol";
import {
...
abstract contract UniswapV4StandardExchangeCommonV2 is IUnlockCallback, ISecurePullErrors {
    ...
    function _supportsInventoryQuote() internal view returns (bool) {
        return UniswapV4QuoteServiceV2._supportsProjectedHook(_poolKey()) && !UniswapV4PositionRepoV2._isImportedPosition();
    }
    ...
    function _inventorySharesIn(InventoryQuote memory q, uint256 amount) internal view returns (uint256) {
        ...
        if (!q.idle) {
            (uint256 total0, uint256 total1) = _inventoryTotals(q);
            return q.token0
                ? StandardExchangeConstantProduct._sharesForSingleExit(total0, total1, amount, q.supply)
                : StandardExchangeConstantProduct._sharesForSingleExit(total1, total0, amount, q.supply);
        }
    ...
    function _inventorySwap(InventoryQuote memory q, uint256 amount) internal view returns (uint256) {
        ...
        return UniswapV4QuoteServiceV2._adjustHookSwap(_poolKey(), result.amountOut, true);
    }
    ...
    function _poolManager() internal view returns (IPoolManager) {
        return UniswapV4PoolManagerAwareRepoV2._poolManager();
    }

    function _poolKey() internal view returns (PoolKey memory) {
        return UniswapV4PoolKeyAwareRepoV2._poolKey();
    }

    function _poolId() internal view returns (PoolId) {
        return UniswapV4PoolKeyAwareRepoV2._poolId();
    }

    function _currency0() internal view returns (Currency) {
        return UniswapV4PoolKeyAwareRepoV2._currency0();
    }

    function _currency1() internal view returns (Currency) {
        return UniswapV4PoolKeyAwareRepoV2._currency1();
    }
        ...
        returns (uint128 liquidity, uint256 feeGrowthInside0LastX128, uint256 feeGrowthInside1LastX128)
    {
        if (UniswapV4PositionRepoV2._isImportedPosition()) {
            (int24 lower, int24 upper) = UniswapV4PositionRepoV2._positionTicks();
            (, feeGrowthInside0LastX128, feeGrowthInside1LastX128) = StateLibrary.getPositionInfo(
                _poolManager(), _poolId(), address(UniswapV4PositionRepoV2._importedPositionManager()),
                lower, upper, bytes32(UniswapV4PositionRepoV2._importedPositionTokenId())
            );
            liquidity = UniswapV4PositionRepoV2._importedPositionManager()
                .getPositionLiquidity(UniswapV4PositionRepoV2._importedPositionTokenId());
            return (liquidity, feeGrowthInside0LastX128, feeGrowthInside1LastX128);
        }

        if (!UniswapV4PositionRepoV2._isPositionCreated()) {
            return (0, 0, 0);
        }

        (int24 tickLower, int24 tickUpper) = UniswapV4PositionRepoV2._positionTicks();
        return StateLibrary.getPositionInfo(
            _poolManager(), _poolId(), address(this), tickLower, tickUpper, UniswapV4PositionRepoV2._salt()
        );
    }
    ...
    function _managedTicks() internal view returns (ManagedTicks memory managedTicks) {
        if (UniswapV4PositionRepoV2._isImportedPosition()) {
            (managedTicks.centerLower, managedTicks.centerUpper) =
                UniswapV4PositionRepoV2._positionTicks();
            return managedTicks;
        }
    ...
    function _collectManagedFeesIfIdle() internal {
        ...
        if (UniswapV4PositionRepoV2._isImportedPosition()) {
            ...
            params[0] = abi.encode(UniswapV4PositionRepoV2._importedPositionTokenId(), uint256(0), uint128(0), uint128(0), bytes(""));
            params[1] = abi.encode(_currency0(), _currency1(), address(this));
            UniswapV4PositionRepoV2._importedPositionManager().modifyLiquidities(
            ...
            _executeUnlock(OperationParams({
                ...
                tickLower: lower, tickUpper: upper, liquidity: 0, salt: UniswapV4PositionRepoV2._salt()
            }));
        }
    }
    ...
    function _emitRebalanceEvent(uint256 liquidPct) internal {
        ...
        (uint256 deployed0, uint256 deployed1) = _deployedAmounts();
        emit IUniswapV4StandardExchangeLiquidReserveV2.LiquidReserveRebalanced(
    ...
    function _deployExcessLiquidity(uint256 excess0, uint256 excess1) internal returns (bool moved) {
        ...
        ManagedTicks memory managedTicks =
            UniswapV4PositionRepoV2._isPositionCreated() ? _managedTicks() : _deriveManagedTicks();
        ...
        _executeUnlock(
            OperationParams({
                ...
                salt: UniswapV4PositionRepoV2._salt()
            })
        );
        moved = true;
    }
    ...
    function _createManagedPositionsIfNeededCommon(ManagedTicks memory managedTicks) internal {
        ...
        UniswapV4PositionRepoV2._createPositionIfNeeded(
            managedTicks.centerLower, managedTicks.centerUpper
        );
    }

    function _increaseImportedPositionCommon(uint128 liquidity, uint128 amount0Max, uint128 amount1Max) internal {
        address pm = address(UniswapV4PositionRepoV2._importedPositionManager());
        ...
        bytes[] memory params = new bytes[](2);
        params[0] = abi.encode(
            UniswapV4PositionRepoV2._importedPositionTokenId(), uint256(liquidity), amount0Max, amount1Max, bytes("")
        );
        params[1] = abi.encode(_currency0(), _currency1());
        UniswapV4PositionRepoV2._importedPositionManager().modifyLiquidities(abi.encode(actions, params), block.timestamp);
        ...
        internal view returns (uint256)
    {
        ...
        return UniswapV4QuoteServiceV2._adjustHookSwap(_poolKey(), quote.amountOut, true);
    }

    function _quoteSwapOut(uint256 amountOut, bool zeroForOne) internal view returns (uint256 amountIn) {
        return UniswapV4QuoteServiceV2._quoteDirectExactOutput(
            UniswapV4QuoteServiceV2.DirectQuoteParams({
    ...
    function _quoteSwapIn(uint256 amountIn, bool zeroForOne) internal view returns (uint256 amountOut) {
        return UniswapV4QuoteServiceV2._quoteDirectExactInput(
            UniswapV4QuoteServiceV2.DirectQuoteParams({
                manager: _poolManager(), key: _poolKey(), zeroForOne: zeroForOne, amount: amountIn
            })
        );
    ...
    function _deriveManagedTicks() internal view returns (ManagedTicks memory managedTicks) {
        int24 tickSpacing = UniswapV4PoolKeyAwareRepoV2._tickSpacing();
