...
abstract contract TestBase_UniswapV4StandardExchangeV2 is TestBase_Permit2, TestBase_VaultComponents {
    using UniswapV4_Component_FactoryServiceV2 for ICreate3FactoryProxy;
    using UniswapV4_Component_FactoryServiceV2 for IFacet;
    using UniswapV4_Component_FactoryServiceV2 for IIndexedexManagerProxy;
    ...
    IUniswapV4StandardExchangeDFPkgV2 internal uniswapV4StandardExchangeDFPkg;
    ...
    function setUp() public virtual override(TestBase_Permit2, TestBase_VaultComponents) {
        ...
        IVaultFeeOracleManager(address(indexedexManager))
            .setDefaultLiquidReservePercentageOfTypeId(
                type(IUniswapV4StandardExchangeLiquidReserveV2).interfaceId, DEFAULT_V4_LIQUID_RESERVE_PCT
            );

        IUniswapV4StandardExchangeDFPkgV2.PkgInit memory pkgInit =
            UniswapV4_Component_FactoryServiceV2.buildArgsUniswapV4StandardExchangePkgInit(_univ4SePkgInitCore());
        pkgInit = UniswapV4_Component_FactoryServiceV2.attachTwapOracle(pkgInit, twapOracle);
        pkgInit = UniswapV4_Component_FactoryServiceV2.attachUniswapV4StandardExchangeMultiFacets(
            pkgInit,
    ...
    function _univ4SePkgInitCore()
        internal
        view
        returns (UniswapV4_Component_FactoryServiceV2.Univ4SePkgInitCore memory a)
    {
