...
import {
    UniswapV3StandardExchangeInMultiQueryTargetV2
} from "contracts/vaults/standard/exchange/protocols/uniswap/v3/UniswapV3StandardExchangeInMultiQueryTargetV2.sol";

contract UniswapV3StandardExchangeInMultiQueryFacetV2 is UniswapV3StandardExchangeInMultiQueryTargetV2, IFacet {
    function facetName() public pure override returns (string memory name) {
        return type(UniswapV3StandardExchangeInMultiQueryFacetV2).name;
    }
