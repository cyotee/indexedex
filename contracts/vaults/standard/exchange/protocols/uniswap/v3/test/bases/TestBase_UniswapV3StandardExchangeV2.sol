...
/**
 * @title TestBase_UniswapV3StandardExchangeV2
 * @notice Gold TestBase: CREATE3 facets + manager-registry DFPkg + hermetic Uni V3 factory/pools.
 */
abstract contract TestBase_UniswapV3StandardExchangeV2 is
    TestBase_Permit2,
    ...
    IUniswapV3SwapCallback
{
    ...
    using UniswapV3_Component_FactoryServiceV2 for IFacet;
    using UniswapV3_Component_FactoryServiceV2 for IIndexedexManagerProxy;
    ...
    IUniswapV3StandardExchangeDFPkgV2 internal uniswapV3StandardExchangeDFPkg;
    ...
    function setUp() public virtual override(TestBase_Permit2, TestBase_VaultComponents) {
        ...
        pkgInit = UniswapV3_Component_FactoryServiceV2.attachUniswapV3StandardExchangeMultiFacets(
            pkgInit,
        ...
        IVaultFeeOracleManager(address(indexedexManager)).setDefaultLiquidReservePercentageOfTypeId(
            type(IUniswapV3StandardExchangeLiquidReserveV2).interfaceId, DEFAULT_V3_LIQUID_RESERVE_PCT
        );
