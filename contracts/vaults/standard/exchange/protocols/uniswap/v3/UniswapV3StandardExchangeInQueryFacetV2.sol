...
import {
    UniswapV3StandardExchangeInQueryTargetV2
} from "contracts/vaults/standard/exchange/protocols/uniswap/v3/UniswapV3StandardExchangeInQueryTargetV2.sol";

/**
 * @title UniswapV3StandardExchangeInQueryFacetV2
 * @notice Inventory-transition queries; split from standard previews to remain under EIP-170.
 */
contract UniswapV3StandardExchangeInQueryFacetV2 is UniswapV3StandardExchangeInQueryTargetV2, IFacet {
