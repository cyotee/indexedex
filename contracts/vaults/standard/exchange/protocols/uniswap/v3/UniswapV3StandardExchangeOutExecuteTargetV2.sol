...
abstract contract UniswapV3StandardExchangeOutExecuteTargetV2 is UniswapV3StandardExchangeOutBaseV2 {
    ...
    function _executeQuotedSwapOut(
        ...
        // A prepared exact-output call commits the full caller-specified maximum.
        ...
        // The prepared input is already present in the entry balance.
