...
/// @title UniswapV4StandardExchangeOrbitalDETFExchangeFacet
/// @notice Exchange In/Out only (Option 1e size split from lifecycle mega-Facet).
contract UniswapV4StandardExchangeOrbitalDETFExchangeFacet is
    IFacet,
    UniswapV4StandardExchangeOrbitalDETFExchangeInTarget
{
    function facetName() external pure returns (string memory) {
        return "UniswapV4StandardExchangeOrbitalDETFExchangeFacet";
    }
    ...
    {
        name_ = "UniswapV4StandardExchangeOrbitalDETFExchangeFacet";
        interfaces_ = new bytes4[](1);
        interfaces_[0] = type(IStandardExchangeIn).interfaceId;
        funcs_ = new bytes4[](2);
        funcs_[0] = IStandardExchangeIn.exchangeIn.selector;
