...
Typed surface: `IUniswapV4StandardExchangeCurveQuadStableDETDFPkg.deployVault(PkgArgs args, uint256 mineNonce)`. The nonce is **not** a PkgArgs field. Caller premines via `UniswapV4DetfHookPremineLib`. Deploy arity SoT: [`UNISWAP_V4_SE_DETF_DEPLOY_MINE_NONCE_PRD.md`](../../../UNISWAP_V4_SE_DETF_DEPLOY_MINE_NONCE_PRD.md).
