...
Family Uni V4 Curve Quad Stable DETF diamond is **deleted**. Do not restore this package.
...
Curve Quad buffer **hook** remains under `contracts/hooks/uniswap/v4/standardExchange/stable/quad/curve/`.
