...
/**
 * @title TestBase_UniswapV4Detf_Cp_MorphoBlueSe
 * @notice H-CP-MB: CP SE buffer hook + MorphoBlueStandardExchange (loanToken = hook pair).
 * @dev createMarket in the test before deployVault. No borrow. Dummy collateral not in hook.tokens().
 ...
 */
abstract contract TestBase_UniswapV4Detf_Cp_MorphoBlueSe is TestBase_UniswapV4Detf {
    ...
    function setUp() public virtual override {
        ...
        pm = IPoolManager(address(IPoolManager(create3Factory.create3WithArgs(
            ...
            keccak256("TestBase_UniswapV4Detf_Cp_MorphoBlueSe_PoolManager")
        ))));
