...
/**
 * @title IUniswapV4DetfBondNFTVaultDFPkg
 * @notice Interface for Protocol NFT Vault Diamond Factory Package.
 */
interface IUniswapV4DetfBondNFTVaultDFPkg is IDiamondFactoryPackage {
    struct PkgInit {
        IFacet erc721Facet;
...
/**
 * @title UniswapV4DetfBondNFTVaultDFPkg
 * @author cyotee doge <not_cyotee@proton.me>
 * @notice Diamond Factory Package for deploying Protocol NFT Vaults.
 */
contract UniswapV4DetfBondNFTVaultDFPkg is IUniswapV4DetfBondNFTVaultDFPkg, IStandardVaultPkg {
    ...
    UniswapV4DetfBondNFTVaultDFPkg SELF;
