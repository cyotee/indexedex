...
import {MixedBufferMultiVaultStableDetfExchangeQueryTarget} from "./MixedBufferMultiVaultStableDetfExchangeQueryTarget.sol";
...
contract MixedBufferMultiVaultStableDetfExchangeInFacet is IFacet, MixedBufferMultiVaultStableDetfExchangeQueryTarget {
    function facetName() public pure returns (string memory) { return type(MixedBufferMultiVaultStableDetfExchangeInFacet).name; }
