...
```bash
forge test --match-path 'test/foundry/spec/vaults/detf/composed/stable/common/*NaturalExpansion*' -vvv
forge test --match-path 'test/foundry/spec/vaults/detf/composed/stable/common/*ProtocolCompound*' -vv
