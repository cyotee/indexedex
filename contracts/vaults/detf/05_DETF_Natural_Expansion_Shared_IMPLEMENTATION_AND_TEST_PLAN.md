...
Path: `contracts/vaults/detf/core/DETFNaturalExpansionLib.sol`
...
| File | Action |
|------|--------|
| `contracts/vaults/detf/core/DETFNaturalExpansionLib.sol` | **Create** |
| `test/foundry/spec/vaults/detf/core/DETFNaturalExpansionLib.t.sol` | **Create** pure tests |
...
```bash
forge test --match-path test/foundry/spec/vaults/detf/core/DETFNaturalExpansionLib.t.sol -vvv
```
