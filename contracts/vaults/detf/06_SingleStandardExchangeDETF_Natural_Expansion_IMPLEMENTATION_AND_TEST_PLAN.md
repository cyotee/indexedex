...
```bash
forge test --match-path 'test/foundry/spec/vaults/detf/standardExchange/single/*NaturalExpansion*' -vvv
forge test --match-path 'test/foundry/spec/vaults/detf/standardExchange/single/*ProtocolCompound*' -vv
