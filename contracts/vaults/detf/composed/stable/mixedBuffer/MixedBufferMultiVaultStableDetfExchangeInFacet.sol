...
} from "contracts/vaults/detf/composed/stable/mixedBuffer/MixedBufferMultiVaultStableDetfExchangeQueryTarget.sol";
import {
    ...
    MixedBufferMultiVaultStableDetfInfoTarget
{
    ...
    function facetFuncs() external pure returns (bytes4[] memory funcs_) {
        ...
        funcs_[6] = IMixedBufferMultiVaultStableDetfBonding.sellPositionToProtocol.selector;
