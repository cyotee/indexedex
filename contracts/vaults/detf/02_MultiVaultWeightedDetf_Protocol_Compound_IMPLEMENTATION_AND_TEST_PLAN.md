...
| Tests | `test/foundry/spec/vaults/detf/composed/multi-vault-weighted/` |
...
```bash
forge test --match-path 'test/foundry/spec/vaults/detf/composed/multi-vault-weighted/*ProtocolCompound*' -vvv
