...
| New tests under `test/foundry/spec/vaults/detf/standardExchange/single/` | see §5 |
...
```bash
forge test --match-path 'test/foundry/spec/vaults/detf/standardExchange/single/*ProtocolCompound*' -vvv
