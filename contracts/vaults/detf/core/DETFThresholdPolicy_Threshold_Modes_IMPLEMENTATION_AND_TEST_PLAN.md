...
| Item | Today |
|------|--------|
| File | `contracts/vaults/detf/core/DETFThresholdPolicy.sol` |
...
| Pure unit tests | **None** under `test/foundry/spec/vaults/detf/core/` |
...
| File | Action |
|------|--------|
| `contracts/vaults/detf/core/DETFThresholdPolicy.sol` | **Extend** (enum, constants, resolve, validate, 3-arg allow, 2-arg wrappers, errors) |
| `test/foundry/spec/vaults/detf/core/DETFThresholdPolicy.t.sol` | **Create** pure unit tests |
...
**Contract:** `test/foundry/spec/vaults/detf/core/DETFThresholdPolicy.t.sol`  
