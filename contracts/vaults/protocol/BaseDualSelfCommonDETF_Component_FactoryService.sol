...
/**
 * @title BaseDualSelfCommonDETF_Component_FactoryService
 ...
 */
library BaseDualSelfCommonDETF_Component_FactoryService {
    /* ---------------------------------------------------------------------- */
    /*                          Helper Structs                                */
    /* ---------------------------------------------------------------------- */
    ...
    ) internal pure returns (IBaseDualSelfCommonDETFDFPkg.PkgInit memory pkgInit) {
        pkgInit = IBaseDualSelfCommonDETFDFPkg.PkgInit({
    ...
    function buildProtocolDETFPkgArgs(string memory name, string memory symbol, IBaseDualSelfCommonDETFDFPkg.PkgArgs memory args)
        internal
        pure
        returns (IBaseDualSelfCommonDETFDFPkg.PkgArgs memory pkgArgs)
    {
        args.name = name;
        args.symbol = symbol;
        return args;
