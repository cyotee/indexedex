...
/**
 * @title IEthereumDualSelfCommonDETFDFPkg
 ...
 */
interface IEthereumDualSelfCommonDETFDFPkg is IDiamondFactoryPackage {
    struct PkgInit {
        IFacet erc20Facet;
        IFacet erc5267Facet;
        IFacet erc2612Facet;
...
/**
 * @title EthereumDualSelfCommonDETFDFPkg
 ...
 */
contract EthereumDualSelfCommonDETFDFPkg is IEthereumDualSelfCommonDETFDFPkg, IStandardVaultPkg {
    ...
    function packageName() public pure returns (string memory name_) {
        return type(EthereumDualSelfCommonDETFDFPkg).name;
    }
    ...
    function updatePkg(address expectedProxy, bytes memory pkgArgs) public virtual returns (bool) {
        ...
        if (args.funder == address(0)) {
            revert("EthereumDualSelfCommonDETFDFPkg: no funder");
        }
