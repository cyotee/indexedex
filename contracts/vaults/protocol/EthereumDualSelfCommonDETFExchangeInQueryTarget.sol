...
contract EthereumDualSelfCommonDETFExchangeInQueryTarget is EthereumDualSelfCommonDETFCommon {
	...
	function _previewBptToWeth(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 bptAmount)
		internal
		view
	...
	function _previewChirRedemption(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 amountIn_)
		internal
		view
	...
	function _previewRichirToWeth(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 richirAmount_)
		internal
		view
		returns (uint256 amountOut_)
	{
	...
	function _previewRichToRichir(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 richIn_)
		internal
		view
	 ...
	 */
	function _previewWethToRichir(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 wethIn_)
		internal
		view
		returns (uint256 richirOut_)
	{
	...
	function _previewWethToRich(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 wethIn_)
		internal
		view
	...
	function _previewRichToWeth(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 richIn_)
		internal
		view
