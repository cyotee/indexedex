...
import {
    EthereumDualSelfCommonDETFBondingQueryTarget
} from "contracts/vaults/protocol/EthereumDualSelfCommonDETFBondingQueryTarget.sol";

contract EthereumDualSelfCommonDETFBondingQueryFacet is EthereumDualSelfCommonDETFBondingQueryTarget, IFacet {
    function facetName() external pure returns (string memory name) {
        return type(EthereumDualSelfCommonDETFBondingQueryFacet).name;
    }
    ...
    {
        name = type(EthereumDualSelfCommonDETFBondingQueryFacet).name;
