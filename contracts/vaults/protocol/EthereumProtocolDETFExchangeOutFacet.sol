...
contract EthereumProtocolDETFExchangeOutFacet is EthereumProtocolDETFExchangeOutTarget, IFacet {
    function facetName() external pure returns (string memory name) {
        return type(EthereumProtocolDETFExchangeOutFacet).name;
    }
    ...
    {
        name = type(EthereumProtocolDETFExchangeOutFacet).name;
