...
import {BaseDualSelfCommonDETFBridgeTarget} from "contracts/vaults/protocol/BaseDualSelfCommonDETFBridgeTarget.sol";

contract BaseDualSelfCommonDETFBridgeFacet is BaseDualSelfCommonDETFBridgeTarget, IFacet {
    function facetName() external pure returns (string memory name) {
        return type(BaseDualSelfCommonDETFBridgeFacet).name;
    }
    ...
    {
        name = type(BaseDualSelfCommonDETFBridgeFacet).name;
