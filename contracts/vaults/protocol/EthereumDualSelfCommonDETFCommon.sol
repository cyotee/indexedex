...
/**
 * @title EthereumDualSelfCommonDETFCommon
 ...
 */
abstract contract EthereumDualSelfCommonDETFCommon is UniswapV2DualEmbeddedDETFCommon, BaseDualSelfCommonDETFCommon {
    function _loadPoolReserves(BaseDualSelfCommonDETFRepo.Storage storage layout_, PoolReserves memory reserves_)
        internal
        view
        virtual
        override
