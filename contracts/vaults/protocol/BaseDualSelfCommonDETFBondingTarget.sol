...
/**
 * @title IBaseDualSelfCommonDETFBonding
 * @notice Interface for Protocol DETF bonding operations.
 */
interface IBaseDualSelfCommonDETFBonding {
    /**
...
/**
 * @title BaseDualSelfCommonDETFBondingTarget
 ...
 */
contract BaseDualSelfCommonDETFBondingTarget is BaseDualSelfCommonDETFCommon, ReentrancyLockModifiers {
    ...
    function _burnAerodromeLpToChirWeth(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct, address poolAddr, uint256 lpOut)
        internal
