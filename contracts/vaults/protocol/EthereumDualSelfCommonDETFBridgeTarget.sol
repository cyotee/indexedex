...
contract EthereumDualSelfCommonDETFBridgeTarget is EthereumDualSelfCommonDETFCommon, ReentrancyLockModifiers {
    ...
    function _addToReservePool(BaseDualSelfCommonDETFRepo.Storage storage layoutStruct_, uint256 tokenIndexIn_, uint256 vaultShares)
        internal
