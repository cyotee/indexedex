...
import {EthereumDualSelfCommonDETFBridgeTarget} from "contracts/vaults/protocol/EthereumDualSelfCommonDETFBridgeTarget.sol";

contract EthereumDualSelfCommonDETFBridgeFacet is EthereumDualSelfCommonDETFBridgeTarget, IFacet {
    function facetName() external pure returns (string memory name) {
        return type(EthereumDualSelfCommonDETFBridgeFacet).name;
    }
    ...
    {
        name = type(EthereumDualSelfCommonDETFBridgeFacet).name;
