...
contract EthereumProtocolDETFBridgeTarget is EthereumProtocolDETFCommon, ReentrancyLockModifiers {
    ...
    function _exitReservePoolProportionalForBridge(BaseProtocolDETFRepo.Storage storage layoutStruct_, uint256 bptIn_)
        internal
    ...
    function _sweepBridgeRichDust(BaseProtocolDETFRepo.Storage storage layoutStruct_) internal {
    ...
    function _addToReservePool(BaseProtocolDETFRepo.Storage storage layoutStruct_, uint256 tokenIndexIn_, uint256 vaultShares)
        internal
