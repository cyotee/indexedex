...
contract EthereumDualSelfCommonDETFExchangeOutFacet is EthereumDualSelfCommonDETFExchangeOutTarget, IFacet {
    function facetName() external pure returns (string memory name) {
        return type(EthereumDualSelfCommonDETFExchangeOutFacet).name;
    }
    ...
    {
        name = type(EthereumDualSelfCommonDETFExchangeOutFacet).name;
