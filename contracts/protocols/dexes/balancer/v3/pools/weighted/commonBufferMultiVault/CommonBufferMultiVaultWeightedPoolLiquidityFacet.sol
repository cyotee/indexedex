...
import {CommonBufferMultiVaultWeightedPoolLiquidityTarget} from
    "contracts/protocols/dexes/balancer/v3/pools/weighted/commonBufferMultiVault/CommonBufferMultiVaultWeightedPoolLiquidityTarget.sol";

contract CommonBufferMultiVaultWeightedPoolLiquidityFacet is
    CommonBufferMultiVaultWeightedPoolLiquidityTarget,
    IFacet
{
    function facetName() public pure returns (string memory) {
        return type(CommonBufferMultiVaultWeightedPoolLiquidityFacet).name;
    }
