...
import {MixedLegWeightedBufferPoolHookTarget} from
...
contract MixedLegWeightedBufferPoolHookFacet is MixedLegWeightedBufferPoolHookTarget, IFacet {
    ...
    function facetName() public pure returns (string memory) {
        return type(MixedLegWeightedBufferPoolHookFacet).name;
    }
