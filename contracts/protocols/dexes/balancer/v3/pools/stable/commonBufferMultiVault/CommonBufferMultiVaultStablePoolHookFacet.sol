...
import {
    CommonBufferMultiVaultStablePoolHookTarget
} from "contracts/protocols/dexes/balancer/v3/pools/stable/commonBufferMultiVault/CommonBufferMultiVaultStablePoolHookTarget.sol";
import {
...
contract CommonBufferMultiVaultStablePoolHookFacet is CommonBufferMultiVaultStablePoolHookTarget, IFacet {
    ...
    function facetName() public pure returns (string memory) {
        return type(CommonBufferMultiVaultStablePoolHookFacet).name;
    }
