...
import {
    MixedBufferMultiVaultStablePoolLiquidityTarget
} from "contracts/protocols/dexes/balancer/v3/pools/stable/mixedBufferMultiVault/MixedBufferMultiVaultStablePoolLiquidityTarget.sol";

contract MixedBufferMultiVaultStablePoolLiquidityFacet is MixedBufferMultiVaultStablePoolLiquidityTarget, IFacet {
    function facetName() public pure returns (string memory) {
        return type(MixedBufferMultiVaultStablePoolLiquidityFacet).name;
    }
