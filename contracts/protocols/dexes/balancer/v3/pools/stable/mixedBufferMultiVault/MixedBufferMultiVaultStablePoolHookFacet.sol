...
import {
    MixedBufferMultiVaultStablePoolHookTarget
} from "contracts/protocols/dexes/balancer/v3/pools/stable/mixedBufferMultiVault/MixedBufferMultiVaultStablePoolHookTarget.sol";
import {
...
contract MixedBufferMultiVaultStablePoolHookFacet is MixedBufferMultiVaultStablePoolHookTarget, IFacet {
    ...
    function facetName() public pure returns (string memory) {
        return type(MixedBufferMultiVaultStablePoolHookFacet).name;
    }
