...
import {
    EtherFiWeETHStandardExchangeInTarget
} from "contracts/protocols/staking/etherfi/EtherFiWeETHStandardExchangeInTarget.sol";

/**
 * @title EtherFiWeETHStandardExchangeInFacet
 * @dev Exact-input routes and optional sequential provider quotes; no native ETH entry.
 */
contract EtherFiWeETHStandardExchangeInFacet is EtherFiWeETHStandardExchangeInTarget, IFacet {
    function facetName() public pure returns (string memory) {
        return type(EtherFiWeETHStandardExchangeInFacet).name;
    }
