...
import {RebasingAwareERC4626Target} from
    "contracts/protocols/staking/rebasingVault/RebasingAwareERC4626Target.sol";

contract RebasingAwareERC4626Facet is RebasingAwareERC4626Target, IFacet {
    function facetName() public pure returns (string memory name) {
        return type(RebasingAwareERC4626Facet).name;
    }
