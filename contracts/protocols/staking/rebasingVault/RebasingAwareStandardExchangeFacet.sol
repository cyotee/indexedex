...
import {RebasingAwareStandardExchangeTarget} from
    "contracts/protocols/staking/rebasingVault/RebasingAwareStandardExchangeTarget.sol";

contract RebasingAwareStandardExchangeFacet is RebasingAwareStandardExchangeTarget, IFacet {
    function facetName() public pure returns (string memory name) {
        return type(RebasingAwareStandardExchangeFacet).name;
    }
