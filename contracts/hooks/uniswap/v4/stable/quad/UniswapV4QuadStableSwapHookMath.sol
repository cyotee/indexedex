...
/**
 * @title UniswapV4QuadStableSwapHookMath
 ...
 *      No storage, no external calls. Fixtures in `UniswapV4QuadStableSwapHook_Math.t.sol` are law.
 * @custom:divergences Fee helpers are fee-on-output (exact-in deduct / exact-out gross-up). Orbital peer is fee-on-input.
 */
library UniswapV4QuadStableSwapHookMath {
