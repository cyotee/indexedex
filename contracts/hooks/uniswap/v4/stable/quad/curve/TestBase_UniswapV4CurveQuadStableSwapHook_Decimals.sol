...
/**
 * @title TestBase_UniswapV4CurveQuadStableSwapHook_Decimals
 * @notice Quad Curve book-decimal underlyings. Hook LP stays 18.
 ...
 */
abstract contract TestBase_UniswapV4CurveQuadStableSwapHook_Decimals is TestBase_VaultComponents {
    ...
    function setUp() public virtual override {
        ...
        pm = IPoolManager(address(IPoolManager(create3Factory.create3WithArgs(
            ...
            keccak256("TestBase_UniswapV4CurveQuadStableSwapHook_Decimals_PoolManager")
        ))));
