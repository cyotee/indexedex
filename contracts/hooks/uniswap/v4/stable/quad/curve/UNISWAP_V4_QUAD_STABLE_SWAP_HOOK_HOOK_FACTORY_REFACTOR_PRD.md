...
**Name:** `UniswapV4CurveQuadStableSwapHook` → **Hook Diamond Package**  
**Date:** 2026-08-04  
...
| Term | Meaning |
|------|---------|
| **Legacy quad** | Current tree: monomorph `UniswapV4CurveQuadStableSwapHook` + `UniswapV4CurveQuadStableSwapHookFactory` (ecosystem CREATE3 + `HookMinerCreate3` + all-six pool ensure) |
...
| Product `UniswapV4CurveQuadStableSwapHookFactory` owns mine+deploy | Product factory must not replace ecosystem hook factory |
...
contracts/hooks/uniswap/v4/stable/quad/curve/
  UniswapV4CurveQuadStableSwapHook.sol                 # monomorph entry
  UniswapV4CurveQuadStableSwapHookTarget.sol
  UniswapV4CurveQuadStableSwapHookCommon.sol           # many immutables
  UniswapV4CurveQuadStableSwapHookRepo.sol
  UniswapV4CurveQuadStableSwapHookMath.sol
  UniswapV4CurveQuadStableSwapHookFactory.sol          # CREATE3 + six doors
  UniswapV4CurveQuadStableSwapHookDeployer.sol
  UniswapV4CurveQuadStableSwapHook_FactoryService.sol  # HookMinerCreate3
  TestBase_UniswapV4CurveQuadStableSwapHook.sol
  interfaces/IUniswapV4CurveQuadStableSwapHook.sol
  interfaces/IUniswapV4CurveQuadStableSwapHookFactory.sol
...
| # | Decision | Value |
|---|----------|--------|
| Q1 | Product name | Keep **`UniswapV4CurveQuadStableSwapHook`** |
| Q2 | Package type | **`UniswapV4CurveQuadStableSwapHookDFPkg`** + `IUniswapV4CurveQuadStableSwapHookPackage` |
| Q3 | Path | `contracts/hooks/uniswap/v4/stable/quad/curve/` |
...
| # | Decision | Value |
|---|----------|--------|
| Q12 | `PRODUCT_ID` | `keccak256("uv4-curve-quad-stable-swap-hook")` (lock in plan) |
...
contracts/hooks/uniswap/v4/stable/quad/curve/
  interfaces/
    IUniswapV4CurveQuadStableSwapHook.sol           # keep/extend instance ABI
    IUniswapV4CurveQuadStableSwapHookPackage.sol    # NEW
  facets/
    UniswapV4CurveQuadStableSwapHookFacet.sol       # NEW
  UniswapV4CurveQuadStableSwapHookDFPkg.sol         # NEW
  UniswapV4CurveQuadStableSwapHookTarget.sol        # REWRITE (Repo bindings)
  UniswapV4CurveQuadStableSwapHookRepo.sol          # EXTEND
  UniswapV4CurveQuadStableSwapHookMath.sol          # keep
  UniswapV4CurveQuadStableSwapHook_FactoryService.sol  # facet/deployPkg + ensurePairPools helpers
  TestBase_UniswapV4CurveQuadStableSwapHook.sol     # rewrite on hook factory ladder
  product PRD (amend deploy) + THIS FILE + follow-on plan

RETIRE after DoD:
  UniswapV4CurveQuadStableSwapHook.sol
  UniswapV4CurveQuadStableSwapHookFactory.sol
  UniswapV4CurveQuadStableSwapHookDeployer.sol
  UniswapV4CurveQuadStableSwapHookCommon.sol
  interfaces/IUniswapV4CurveQuadStableSwapHookFactory.sol
```
...
Ladder: factory TestBase → `TestBase_UniswapV4CurveQuadStableSwapHook`.
...
| Existing TestBase | `./TestBase_UniswapV4CurveQuadStableSwapHook.sol` (rewrite) |
...
6. Monomorph + `UniswapV4CurveQuadStableSwapHookFactory` retired from production.  
