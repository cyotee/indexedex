...
/**
 * @title IUniswapV4CurveQuadStableSwapHookPackage
 * @notice DFPkg interface for Uniswap V4 Quad Stable Swap Hook (hook diamond package).
 ...
 */
interface IUniswapV4CurveQuadStableSwapHookPackage is IUniswapV4HookDiamondPackage, IStandardVaultPkg {
    error ZeroAddress();
    error InvalidToken();
