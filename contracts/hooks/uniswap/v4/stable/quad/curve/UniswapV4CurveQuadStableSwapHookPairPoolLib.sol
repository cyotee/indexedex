...
/**
 * @title UniswapV4CurveQuadStableSwapHookPairPoolLib
 * @notice Product PoolKey construction and skip-if-live initialize for Curve quad pair doors.
 ...
 */
library UniswapV4CurveQuadStableSwapHookPairPoolLib {
