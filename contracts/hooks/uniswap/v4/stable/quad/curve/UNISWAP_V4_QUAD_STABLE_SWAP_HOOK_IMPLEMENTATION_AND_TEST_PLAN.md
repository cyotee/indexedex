...
**Package:** `contracts/hooks/uniswap/v4/stable/quad/curve/`  
**Date:** 2026-08-03  
...
| Topic | Decision |
|-------|----------|
| Product | **`UniswapV4CurveQuadStableSwapHook`** — CREATE3-mined single contract (IHooks + ERC-20 LP) |
...
contracts/hooks/uniswap/v4/stable/quad/curve/
  ...
  interfaces/
    ...
    IUniswapV4CurveQuadStableSwapHookFactory.sol
  ...
  TestBase_UniswapV4CurveQuadStableSwapHook.sol   # gold TestBase (LOCKED path)
```
...
test/foundry/spec/hooks/uniswap/v4/stable/quad/curve/
  UniswapV4CurveQuadStableSwapHook_Math.t.sol
  UniswapV4CurveQuadStableSwapHook_Deploy.t.sol
  UniswapV4CurveQuadStableSwapHook_Factory.t.sol
  UniswapV4CurveQuadStableSwapHook_Liquidity.t.sol
  UniswapV4CurveQuadStableSwapHook_Zap.t.sol
  UniswapV4CurveQuadStableSwapHook_Swap.t.sol
  UniswapV4CurveQuadStableSwapHook_Rates.t.sol
  UniswapV4CurveQuadStableSwapHook_Safety.t.sol
  UniswapV4CurveQuadStableSwapHook_Reentrancy.t.sol

test/foundry/fork/base_main/hooks/uniswap/v4/stable/quad/curve/
  UniswapV4CurveQuadStableSwapHook_Base.t.sol

test/foundry/fork/robinhood_4663/hooks/uniswap/v4/stable/quad/curve/   # LOCKED (not robinhood_main)
  UniswapV4CurveQuadStableSwapHook_Robinhood.t.sol
```
...
**Exit:** `UniswapV4CurveQuadStableSwapHook_Math.t.sol` green with all required FIX-* cases; no external protocol deps.
...
2. Deploy UniswapV4CurveQuadStableSwapHookFactory via CREATE3 with:
...
4. Gold TestBase: package-adjacent `TestBase_UniswapV4CurveQuadStableSwapHook` (`§3.1`).  
   ...
   - **Fork path convention (LOCKED):** `test/foundry/fork/base_main/hooks/uniswap/v4/stable/quad/curve/` and `test/foundry/fork/robinhood_4663/hooks/uniswap/v4/stable/quad/curve/` (match dual SE fork layout; not `robinhood_main` unless that tree is later unified).  
...
**End of plan — UniswapV4CurveQuadStableSwapHook (v1.3 / PRD v0.5.2)**
