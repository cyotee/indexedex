...
/**
 * @title UniswapV4QuadStableSwapHookDFPkg
 ...
 */
contract UniswapV4QuadStableSwapHookDFPkg is IUniswapV4QuadStableSwapHookPackage {
    using BetterEfficientHashLib for bytes;

    bytes32 public constant PRODUCT_ID = keccak256("uv4-quad-stable-swap-hook");
    bytes4 public constant HOOK_VAULT_TYPE = bytes4(keccak256("UniswapV4QuadStableSwapHook"));
    ...
    IUniswapV4QuadStableSwapHookPackage private immutable SELF;
    ...
    function packageName() public pure returns (string memory) {
        return type(UniswapV4QuadStableSwapHookDFPkg).name;
    }
    ...
    function name() public pure returns (string memory) {
        return "UniswapV4QuadStableSwapHook";
    }
