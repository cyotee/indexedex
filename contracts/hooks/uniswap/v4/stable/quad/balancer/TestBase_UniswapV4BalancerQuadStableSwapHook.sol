...
/**
 * @title TestBase_UniswapV4BalancerQuadStableSwapHook
 ...
 */
abstract contract TestBase_UniswapV4BalancerQuadStableSwapHook is TestBase_VaultComponents {
    ...
    function setUp() public virtual override {
        ...
        pm = IPoolManager(address(IPoolManager(create3Factory.create3WithArgs(
            ...
            keccak256("TestBase_UniswapV4BalancerQuadStableSwapHook_PoolManager")
        ))));
    ...
    function _deployBootstrapOnly(IUniswapV4BalancerQuadStableSwapHookPackage.PkgArgs memory args)
        internal
        returns (address)
    {
        uint256 mineNonce = PkgFactory.findMineNonce(hookFactory, hookPkg, args);
