...
/**
 * @title UniswapV4BalancerQuadStableSwapHookRepo
 * @notice Diamond storage: bindings, rate-scaled book, reentrancy.
 * @dev Slot: indexedex.hooks.uv4.stable.quad.balancer.storage
 ...
 */
library UniswapV4BalancerQuadStableSwapHookRepo {
    bytes32 internal constant STORAGE_SLOT = keccak256(
        abi.encode(uint256(keccak256("indexedex.hooks.uv4.stable.quad.balancer.storage")) - 1)
