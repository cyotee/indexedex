...
/**
 * @title UniswapV4StandardExchangeBalancerQuadStableBufferHookLiquidityTarget
 ...
 */
abstract contract UniswapV4StandardExchangeBalancerQuadStableBufferHookLiquidityTarget is
    UniswapV4StandardExchangeBalancerQuadStableBufferHookTarget
{
    ...
    function previewJoinUnbalanced(uint256[] calldata) public pure returns (uint256) {
        revert IUniswapV4StandardExchangeBalancerQuadStableBufferHook.InvalidRoute();
    }
        ...
        returns (uint256 shares)
    {
        ...
        shares = Math.singleJoinExactInShares(
            _invWadAll(),
            Math.scaleTo(invIn, Repo._layout().invScales[idx]),
            idx,
            _amp(),
            supply,
            feeWad
