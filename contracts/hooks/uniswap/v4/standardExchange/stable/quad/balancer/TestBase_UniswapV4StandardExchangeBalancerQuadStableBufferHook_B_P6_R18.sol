...
/// @notice Book `B_P6_R18`. pairToken (construction first) 6-dec; next 18; remaining 18/18. After address sort token0..token3 permute. Hook LP stays 18.
abstract contract TestBase_UniswapV4StandardExchangeBalancerQuadStableBufferHook_B_P6_R18 is TestBase_UniswapV4StandardExchangeBalancerQuadStableBufferHook_Decimals {
