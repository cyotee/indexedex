...
import {
    UniswapV4StandardExchangeBalancerQuadStableBufferHookInitTarget
} from "contracts/hooks/uniswap/v4/standardExchange/stable/quad/balancer/UniswapV4StandardExchangeBalancerQuadStableBufferHookInitTarget.sol";

/**
 * @title UniswapV4StandardExchangeBalancerQuadStableBufferHookInitFacet
 * @notice Source-only IFacet mixin inherited by the DFPkg. Never CREATE3-deployed.
 */
abstract contract UniswapV4StandardExchangeBalancerQuadStableBufferHookInitFacet is
    UniswapV4StandardExchangeBalancerQuadStableBufferHookInitTarget,
    IFacet
{
    function facetName() public pure returns (string memory) {
        return type(UniswapV4StandardExchangeBalancerQuadStableBufferHookInitFacet).name;
    }

    function facetInterfaces() public pure virtual returns (bytes4[] memory interfaces) {
        interfaces = new bytes4[](1);
        interfaces[0] = type(IUniswapV4StandardExchangeBalancerQuadStableBufferHookInit).interfaceId;
    }
