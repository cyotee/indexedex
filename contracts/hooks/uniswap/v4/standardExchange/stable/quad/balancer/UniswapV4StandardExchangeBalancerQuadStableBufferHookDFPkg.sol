...
/**
 * @title UniswapV4StandardExchangeBalancerQuadStableBufferHookDFPkg
 ...
 */
contract UniswapV4StandardExchangeBalancerQuadStableBufferHookDFPkg is
    IUniswapV4StandardExchangeBalancerQuadStableBufferHookPackage
{
    ...
    IUniswapV4StandardExchangeBalancerQuadStableBufferHookPackage private immutable SELF;
    ...
    function packageName() public pure returns (string memory) {
        return type(UniswapV4StandardExchangeBalancerQuadStableBufferHookDFPkg).name;
    }
    ...
    function postDeploy(address proxy) public returns (bool) {
        IUniswapV4StandardExchangeBalancerQuadStableBufferHook h =
            IUniswapV4StandardExchangeBalancerQuadStableBufferHook(proxy);
    ...
    function name() public pure returns (string memory) {
        return "UniswapV4StandardExchangeBalancerQuadStableBufferHook";
    }
