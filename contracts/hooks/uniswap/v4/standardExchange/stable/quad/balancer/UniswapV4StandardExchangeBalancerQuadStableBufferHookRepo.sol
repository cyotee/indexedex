 ...
 * @dev Slot: indexedex.hooks.uv4.se.balancer.stable.quad.buffer.storage
...
library UniswapV4StandardExchangeBalancerQuadStableBufferHookRepo {
    bytes32 internal constant STORAGE_SLOT = keccak256(
        abi.encode(uint256(keccak256("indexedex.hooks.uv4.se.balancer.stable.quad.buffer.storage")) - 1)
