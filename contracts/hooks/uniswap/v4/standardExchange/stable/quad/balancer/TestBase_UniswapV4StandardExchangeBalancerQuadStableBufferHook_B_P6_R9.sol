...
/// @notice Book `B_P6_R9`. pairToken (construction first) 6-dec; next 9; remaining 18/18. After address sort token0..token3 permute. Hook LP stays 18.
abstract contract TestBase_UniswapV4StandardExchangeBalancerQuadStableBufferHook_B_P6_R9 is TestBase_UniswapV4StandardExchangeBalancerQuadStableBufferHook_Decimals {
