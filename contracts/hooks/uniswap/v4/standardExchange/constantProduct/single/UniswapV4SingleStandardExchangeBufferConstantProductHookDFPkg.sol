 ...
 *      After finalize, beforeInitialize lives on SE_FACET (no dedicated hooks facet).
 */
contract UniswapV4SingleStandardExchangeBufferConstantProductHookDFPkg is
    UniswapV4SingleStandardExchangeBufferConstantProductHookInitFacet,
    IUniswapV4SingleStandardExchangeBufferConstantProductHookPackage
{
    ...
    function facetInterfaces()
        public
        pure
        override(IDiamondFactoryPackage, UniswapV4SingleStandardExchangeBufferConstantProductHookInitFacet)
