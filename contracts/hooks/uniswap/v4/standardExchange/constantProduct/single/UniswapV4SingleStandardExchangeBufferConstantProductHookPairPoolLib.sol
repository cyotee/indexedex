...
/**
 * @title UniswapV4SingleStandardExchangeBufferConstantProductHookPairPoolLib
 * @notice Product PoolKey construction and skip-if-live initialize for the one door.
 * @dev Product key: address-sorted currencies, fee = 0, family tick, hooks = proxy.
 */
library UniswapV4SingleStandardExchangeBufferConstantProductHookPairPoolLib {
    using PoolIdLibrary for PoolKey;
    using StateLibrary for IPoolManager;

    int24 internal constant PRODUCT_TICK_SPACING = 60;

    /// @notice Pure pool key for the Single CP product pair (currency-sorted, fee 0).
