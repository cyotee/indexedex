...
/**
 * @title UniswapV4BufferAndPricingHookRepo
 ...
 */
library UniswapV4BufferAndPricingHookRepo {
    bytes32 internal constant STORAGE_SLOT =
        keccak256(abi.encode(uint256(keccak256("indexedex.hooks.uv4.buffer.pricing.storage")) - 1))
