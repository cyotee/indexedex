...
/**
 * @title UniswapV4DualStandardExchangeBufferConstantProductHookPairPoolLib
 * @notice Product PoolKey construction and skip-if-live initialize for the Dual door.
 * @dev Dual product key: address-sorted currencies, fee = 0, family tick, hooks = proxy.
 */
library UniswapV4DualStandardExchangeBufferConstantProductHookPairPoolLib {
    using PoolIdLibrary for PoolKey;
    using StateLibrary for IPoolManager;

    int24 internal constant PRODUCT_TICK_SPACING = 60;

    /// @notice Pure pool key for the Dual product pair (currency-sorted, fee 0).
