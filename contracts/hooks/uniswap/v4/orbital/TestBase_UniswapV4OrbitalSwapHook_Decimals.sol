...
/**
 * @title TestBase_UniswapV4OrbitalSwapHook_Decimals
 * @notice Orbital swap hook with book-decimal underlyings. Hook LP stays 18.
 * @dev Does not call gold token construction. pairToken = token0 role.
 */
abstract contract TestBase_UniswapV4OrbitalSwapHook_Decimals is TestBase_VaultComponents {
    ...
    function setUp() public virtual override {
        ...
        pm = IPoolManager(address(IPoolManager(create3Factory.create3WithArgs(
            ...
            keccak256("TestBase_UniswapV4OrbitalSwapHook_Decimals_PoolManager")
        ))));
    ...
    function _wadHuman(uint256 human) internal pure returns (uint256) {
        return human * 1e18;
    }
