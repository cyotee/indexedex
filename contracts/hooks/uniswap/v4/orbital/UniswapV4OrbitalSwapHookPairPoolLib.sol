 ...
 * @notice Ensure three pair doors (01, 12, 02) for an orbital hook proxy (R30–R33).
 * @dev Idempotent via getSlot0: skip if sqrtPriceX96 != 0; otherwise initialize and
 *      let real failures (hook flags, currency order, spacing) revert the product deploy.
 */
