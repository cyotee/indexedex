...
library UniswapV4TwapOraclePoolManagerAwareRepo {
    bytes32 internal constant DEFAULT_SLOT =
        bytes32(uint256(keccak256(abi.encode("indexedex.oracles.uniswap.v4.twap.pool.manager.aware"))) - 1);
    ...
    function _poolManager(Storage storage layoutStruct) internal view returns (IPoolManager) {
