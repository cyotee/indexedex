...
abstract contract UniswapV4Detf_Orbital_PonsV1Se_Lifecycle_Decimals is TestBase_UniswapV4Detf_Orbital_PonsV1Se_Decimals {
    ...
    function test_H_OR_P1_firstBond() public {
    ...
    function test_H_OR_P1_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_OR_P1_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_OR_P1_close() public {
