...
abstract contract UniswapV4Detf_Weighted_Univ4Se_Lifecycle_Decimals is TestBase_UniswapV4Detf_Weighted_Univ4Se_Decimals {
    ...
    function test_H_WE_GV4_firstBond() public {
    ...
    function test_H_WE_GV4_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_WE_GV4_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_WE_GV4_close() public {
