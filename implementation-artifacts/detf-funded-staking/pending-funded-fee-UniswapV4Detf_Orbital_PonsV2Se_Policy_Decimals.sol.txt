...
abstract contract UniswapV4Detf_Orbital_PonsV2Se_Policy_Decimals is
    ...
    UniswapV4Detf_Stage11PolicySuite_Decimals
{
    function setUp()
        public
        virtual
        override(TestBase_UniswapV4Detf_Orbital_PonsV2Se_Decimals, UniswapV4Detf_Stage11PolicySuite_Decimals)
    {
