...
import {TestBase_UniswapV4Detf_Quad_MorphoMix_Decimals} from
    "contracts/vaults/detf/protocols/dexes/uniswap/v4/detf/TestBase_UniswapV4Detf_Quad_MorphoMix_Decimals.sol";

abstract contract UniswapV4Detf_Quad_MorphoMix_Lifecycle_Decimals is TestBase_UniswapV4Detf_Quad_MorphoMix_Decimals {
    ...
    function test_H_QD_Mix_firstBond() public {
    ...
    function test_H_QD_Mix_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_QD_Mix_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_QD_Mix_close() public {
