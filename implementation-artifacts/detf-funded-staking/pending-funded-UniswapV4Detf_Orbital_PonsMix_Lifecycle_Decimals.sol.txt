...
import {TestBase_UniswapV4Detf_Orbital_PonsMix_Decimals} from
    "contracts/vaults/detf/protocols/dexes/uniswap/v4/detf/TestBase_UniswapV4Detf_Orbital_PonsMix_Decimals.sol";

abstract contract UniswapV4Detf_Orbital_PonsMix_Lifecycle_Decimals is TestBase_UniswapV4Detf_Orbital_PonsMix_Decimals {
    ...
    function test_H_OR_PonsMix_firstBond() public {
    ...
    function test_H_OR_PonsMix_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_OR_PonsMix_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_OR_PonsMix_close() public {
