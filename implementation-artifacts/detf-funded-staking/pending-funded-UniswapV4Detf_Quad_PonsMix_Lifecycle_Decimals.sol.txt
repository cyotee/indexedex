...
abstract contract UniswapV4Detf_Quad_PonsMix_Lifecycle_Decimals is TestBase_UniswapV4Detf_Quad_PonsMix_Decimals {
    ...
    function test_H_QD_PonsMix_firstBond() public {
    ...
    function test_H_QD_PonsMix_mint() public {
        _firstBond(_bondIn());
    ...
    function test_H_QD_PonsMix_burn() public {
        _firstBond(_bondIn());
        vm.startPrank(detfUser);
    ...
    function test_H_QD_PonsMix_close() public {
