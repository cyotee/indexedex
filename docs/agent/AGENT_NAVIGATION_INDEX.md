...
| Uni V4 SE Curve Quad Stable DETF | Co-located PRD + impl plan | `UniswapV4StandardExchangeCurveQuadStableDETF_PRD.md` (**LOCKED v0.4**) | `…/uniswap/v4/standardExchange/stable/quad/curve/` |
